...
class Module_booking
{
	...
	function join_or_login()
	{
		...
		if (get_option('member_booking_only')=='0')
		{
			...
			$form=do_template('FORM',array('_GUID'=>'18e831a00ac918b06c7f761c7d7d5fb0','TEXT'=>do_lang_tempcode('A_FEW_DETAILS'),'HIDDEN'=>$hidden,'FIELDS'=>$fields,'SUBMIT_NAME'=>$submit_name,'URL'=>$url));
			$javascript='';
		} else
		{
			// Integrated signup
