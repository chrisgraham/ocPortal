...
class Module_booking
{
	...
	function uninstall()
	{
		...
		delete_config_option('member_booking_only');
	}
	...
	function install($upgrade_from=NULL,$upgrade_from_hack=NULL)
	{
		...
		{
			add_config_option('MEMBER_BOOKING_ONLY','member_booking_only','tick','return \'0\';','FEATURE','BOOKINGS');
		}
	...
	function thanks()
	{
		...
		// Show success
		$customer_name=post_param('customer_name',is_guest()?'':$GLOBALS['FORUM_DRIVER']->get_username(get_member()));
