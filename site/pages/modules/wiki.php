...
class Module_wiki
{
	...
	function page()
	{
		...
		$_subpage=($or_list=='')?array():list_to_map('id',$GLOBALS['SITE_DB']->query('SELECT id,title,hide_posts FROM '.get_table_prefix().'wiki_pages WHERE '.$or_list,NULL,NULL,false,true));
		foreach ($dbchildren as $myrow)
		{
