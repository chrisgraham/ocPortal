...
class Module_authors
{
	...
	function show_author()
	{
		...
		if (!is_null($handle))
		{
			$forum_details=do_template('AUTHOR_SCREEN_POTENTIAL_ACTION_ENTRY',array('ACTION'=>hyperlink($GLOBALS['FORUM_DRIVER']->member_profile_link($handle,false,true),do_lang_tempcode('AUTHOR_PROFILE'))));
		...
		$url=$details['url'];
		if (strlen($url)>0)
			$url_details=do_template('AUTHOR_SCREEN_POTENTIAL_ACTION_ENTRY',array('ACTION'=>hyperlink($url,do_lang_tempcode('AUTHOR_HOMEPAGE'))));
