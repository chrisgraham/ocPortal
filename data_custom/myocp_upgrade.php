...
// Reset demo
http_download_file('http://ocportal.com/data_custom/ocpcom_web_service.php?call=demo_reset');
...
if ((!is_file($out_path)) || (filesize($out_path)==0))
{
	warn_exit(protect_from_escaping('Failed to create SQL dump...<br /><br />'.$sql_dump_output));
}
unlink($out_path);
