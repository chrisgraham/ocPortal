...
if (!$GLOBALS['SITE_DB']->table_exists('image_url_sub_for'))
{
	$GLOBALS['SITE_DB']->create_table('image_url_sub_for',array(
		'id'=>'*AUTO',
		'url_from'=>'URLPATH',
		'url_to'=>'URLPATH',
		'member_id'=>'USER',
	...
	$GLOBALS['SITE_DB']->create_index('image_url_sub_for','url_from',array('url_from'));
	$GLOBALS['SITE_DB']->create_index('image_url_sub_for','member_id',array('member_id'));
}
