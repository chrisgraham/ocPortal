		CREATE TABLE ocp10_wiki_changes
		(
		...
		CREATE TABLE ocp10_wiki_children
		(
		...
		CREATE INDEX `wiki_changes.the_page` ON ocp10_wiki_changes(the_page);
		ALTER TABLE ocp10_wiki_changes ADD FOREIGN KEY `wiki_changes.the_page` (the_page) REFERENCES ocp10_wiki_pages (id);

		CREATE INDEX `wiki_changes.member_id` ON ocp10_wiki_changes(member_id);
		ALTER TABLE ocp10_wiki_changes ADD FOREIGN KEY `wiki_changes.member_id` (member_id) REFERENCES ocp10_f_members (id);

		CREATE INDEX `wiki_children.parent_id` ON ocp10_wiki_children(parent_id);
		ALTER TABLE ocp10_wiki_children ADD FOREIGN KEY `wiki_children.parent_id` (parent_id) REFERENCES ocp10_wiki_pages (id);

		CREATE INDEX `wiki_children.child_id` ON ocp10_wiki_children(child_id);
		ALTER TABLE ocp10_wiki_children ADD FOREIGN KEY `wiki_children.child_id` (child_id) REFERENCES ocp10_wiki_pages (id);

		CREATE INDEX `wiki_pages.title` ON ocp10_wiki_pages(title);
		ALTER TABLE ocp10_wiki_pages ADD FOREIGN KEY `wiki_pages.title` (title) REFERENCES ocp10_translate (id);

		CREATE INDEX `wiki_pages.description` ON ocp10_wiki_pages(description);
		ALTER TABLE ocp10_wiki_pages ADD FOREIGN KEY `wiki_pages.description` (description) REFERENCES ocp10_translate (id);

		CREATE INDEX `wiki_pages.submitter` ON ocp10_wiki_pages(submitter);
		ALTER TABLE ocp10_wiki_pages ADD FOREIGN KEY `wiki_pages.submitter` (submitter) REFERENCES ocp10_f_members (id);

		CREATE INDEX `wiki_posts.page_id` ON ocp10_wiki_posts(page_id);
		ALTER TABLE ocp10_wiki_posts ADD FOREIGN KEY `wiki_posts.page_id` (page_id) REFERENCES ocp10_wiki_pages (id);

		CREATE INDEX `wiki_posts.the_message` ON ocp10_wiki_posts(the_message);
		ALTER TABLE ocp10_wiki_posts ADD FOREIGN KEY `wiki_posts.the_message` (the_message) REFERENCES ocp10_translate (id);

		CREATE INDEX `wiki_posts.member_id` ON ocp10_wiki_posts(member_id);
		ALTER TABLE ocp10_wiki_posts ADD FOREIGN KEY `wiki_posts.member_id` (member_id) REFERENCES ocp10_f_members (id);
