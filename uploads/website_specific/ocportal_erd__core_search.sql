		...
		CREATE INDEX `searches_saved.s_member_id` ON ocp4_searches_saved(s_member_id);
		ALTER TABLE ocp4_searches_saved ADD FOREIGN KEY `searches_saved.s_member_id` (s_member_id) REFERENCES ocp4_f_members (id);

		CREATE INDEX `searches_logged.s_member_id` ON ocp4_searches_logged(s_member_id);
		ALTER TABLE ocp4_searches_logged ADD FOREIGN KEY `searches_logged.s_member_id` (s_member_id) REFERENCES ocp4_f_members (id);
