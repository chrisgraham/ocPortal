		CREATE TABLE ocp10_match_key_messages
		(
		...
		CREATE INDEX `match_key_messages.k_message` ON ocp10_match_key_messages(k_message);
		ALTER TABLE ocp10_match_key_messages ADD FOREIGN KEY `match_key_messages.k_message` (k_message) REFERENCES ocp10_translate (id);
