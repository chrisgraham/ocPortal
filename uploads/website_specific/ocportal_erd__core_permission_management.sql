		...
		CREATE INDEX `match_key_messages.k_message` ON ocp_match_key_messages(k_message);
		ALTER TABLE ocp_match_key_messages ADD FOREIGN KEY `match_key_messages.k_message` (k_message) REFERENCES ocp_translate (id);
