		...
		CREATE INDEX `hackattack.the_user` ON ocp4_hackattack(the_user);
		ALTER TABLE ocp4_hackattack ADD FOREIGN KEY `hackattack.the_user` (the_user) REFERENCES ocp4_f_members (id);
