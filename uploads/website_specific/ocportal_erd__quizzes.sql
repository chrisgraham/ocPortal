		CREATE TABLE ocp10_quiz_member_last_visit
		(
		...
		CREATE TABLE ocp10_quiz_questions
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp10_quiz_question_answers
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp10_quiz_winner
		(
			q_quiz integer NULL,
		...
		CREATE TABLE ocp10_quiz_entries
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp10_quiz_entry_answer
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp10_newsletters
		(
			id integer auto_increment NULL,
		...
		CREATE INDEX `quiz_member_last_visit.v_member_id` ON ocp10_quiz_member_last_visit(v_member_id);
		ALTER TABLE ocp10_quiz_member_last_visit ADD FOREIGN KEY `quiz_member_last_visit.v_member_id` (v_member_id) REFERENCES ocp10_f_members (id);

		CREATE INDEX `quiz_member_last_visit.v_quiz_id` ON ocp10_quiz_member_last_visit(v_quiz_id);
		ALTER TABLE ocp10_quiz_member_last_visit ADD FOREIGN KEY `quiz_member_last_visit.v_quiz_id` (v_quiz_id) REFERENCES ocp10_quizzes (id);

		CREATE INDEX `quizzes.q_name` ON ocp10_quizzes(q_name);
		ALTER TABLE ocp10_quizzes ADD FOREIGN KEY `quizzes.q_name` (q_name) REFERENCES ocp10_translate (id);

		CREATE INDEX `quizzes.q_start_text` ON ocp10_quizzes(q_start_text);
		ALTER TABLE ocp10_quizzes ADD FOREIGN KEY `quizzes.q_start_text` (q_start_text) REFERENCES ocp10_translate (id);

		CREATE INDEX `quizzes.q_end_text` ON ocp10_quizzes(q_end_text);
		ALTER TABLE ocp10_quizzes ADD FOREIGN KEY `quizzes.q_end_text` (q_end_text) REFERENCES ocp10_translate (id);

		CREATE INDEX `quizzes.q_submitter` ON ocp10_quizzes(q_submitter);
		ALTER TABLE ocp10_quizzes ADD FOREIGN KEY `quizzes.q_submitter` (q_submitter) REFERENCES ocp10_f_members (id);

		CREATE INDEX `quizzes.q_tied_newsletter` ON ocp10_quizzes(q_tied_newsletter);
		ALTER TABLE ocp10_quizzes ADD FOREIGN KEY `quizzes.q_tied_newsletter` (q_tied_newsletter) REFERENCES ocp10_newsletters (id);

		CREATE INDEX `quizzes.q_end_text_fail` ON ocp10_quizzes(q_end_text_fail);
		ALTER TABLE ocp10_quizzes ADD FOREIGN KEY `quizzes.q_end_text_fail` (q_end_text_fail) REFERENCES ocp10_translate (id);

		CREATE INDEX `quiz_questions.q_quiz` ON ocp10_quiz_questions(q_quiz);
		ALTER TABLE ocp10_quiz_questions ADD FOREIGN KEY `quiz_questions.q_quiz` (q_quiz) REFERENCES ocp10_quizzes (id);

		CREATE INDEX `quiz_questions.q_question_text` ON ocp10_quiz_questions(q_question_text);
		ALTER TABLE ocp10_quiz_questions ADD FOREIGN KEY `quiz_questions.q_question_text` (q_question_text) REFERENCES ocp10_translate (id);

		CREATE INDEX `quiz_question_answers.q_question` ON ocp10_quiz_question_answers(q_question);
		ALTER TABLE ocp10_quiz_question_answers ADD FOREIGN KEY `quiz_question_answers.q_question` (q_question) REFERENCES ocp10_quiz_questions (id);

		CREATE INDEX `quiz_question_answers.q_answer_text` ON ocp10_quiz_question_answers(q_answer_text);
		ALTER TABLE ocp10_quiz_question_answers ADD FOREIGN KEY `quiz_question_answers.q_answer_text` (q_answer_text) REFERENCES ocp10_translate (id);

		CREATE INDEX `quiz_question_answers.q_explanation` ON ocp10_quiz_question_answers(q_explanation);
		ALTER TABLE ocp10_quiz_question_answers ADD FOREIGN KEY `quiz_question_answers.q_explanation` (q_explanation) REFERENCES ocp10_translate (id);

		CREATE INDEX `quiz_winner.q_quiz` ON ocp10_quiz_winner(q_quiz);
		ALTER TABLE ocp10_quiz_winner ADD FOREIGN KEY `quiz_winner.q_quiz` (q_quiz) REFERENCES ocp10_quizzes (id);

		CREATE INDEX `quiz_winner.q_entry` ON ocp10_quiz_winner(q_entry);
		ALTER TABLE ocp10_quiz_winner ADD FOREIGN KEY `quiz_winner.q_entry` (q_entry) REFERENCES ocp10_quiz_entries (id);

		CREATE INDEX `quiz_entries.q_member` ON ocp10_quiz_entries(q_member);
		ALTER TABLE ocp10_quiz_entries ADD FOREIGN KEY `quiz_entries.q_member` (q_member) REFERENCES ocp10_f_members (id);

		CREATE INDEX `quiz_entries.q_quiz` ON ocp10_quiz_entries(q_quiz);
		ALTER TABLE ocp10_quiz_entries ADD FOREIGN KEY `quiz_entries.q_quiz` (q_quiz) REFERENCES ocp10_quizzes (id);

		CREATE INDEX `quiz_entry_answer.q_entry` ON ocp10_quiz_entry_answer(q_entry);
		ALTER TABLE ocp10_quiz_entry_answer ADD FOREIGN KEY `quiz_entry_answer.q_entry` (q_entry) REFERENCES ocp10_quiz_entries (id);

		CREATE INDEX `quiz_entry_answer.q_question` ON ocp10_quiz_entry_answer(q_question);
		ALTER TABLE ocp10_quiz_entry_answer ADD FOREIGN KEY `quiz_entry_answer.q_question` (q_question) REFERENCES ocp10_quiz_questions (id);
		...
		CREATE INDEX `newsletters.title` ON ocp10_newsletters(title);
		ALTER TABLE ocp10_newsletters ADD FOREIGN KEY `newsletters.title` (title) REFERENCES ocp10_translate (id);

		CREATE INDEX `newsletters.description` ON ocp10_newsletters(description);
		ALTER TABLE ocp10_newsletters ADD FOREIGN KEY `newsletters.description` (description) REFERENCES ocp10_translate (id);
