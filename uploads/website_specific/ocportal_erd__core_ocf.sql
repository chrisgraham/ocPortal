		...
		CREATE TABLE ocp6_f_custom_fields
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_f_forum_intro_ip
		(
		...
		CREATE TABLE ocp6_f_forum_intro_member
		(
			i_forum_id integer NULL,
		...
		CREATE TABLE ocp6_f_forum_tracking
		(
			r_forum_id integer NULL,
		...
		CREATE TABLE ocp6_f_group_members
		(
		...
		CREATE TABLE ocp6_f_member_cpf_perms
		(
		...
		CREATE TABLE ocp6_f_member_custom_fields
		(
			...
			field_27 integer NOT NULL,
			field_28 integer NOT NULL,
			field_29 integer NOT NULL,
			field_30 integer NOT NULL,
		...
		CREATE TABLE ocp6_f_member_known_login_ips
		(
			i_member_id integer NULL,
			i_ip varchar(40) NULL,
		...
		CREATE TABLE ocp6_f_moderator_logs
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_f_multi_moderations
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_f_poll_answers
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_f_poll_votes
		(
		...
		CREATE TABLE ocp6_f_post_history
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_f_post_templates
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_f_saved_warnings
		(
		...
		CREATE TABLE ocp6_f_special_pt_access
		(
		...
		CREATE TABLE ocp6_f_topic_tracking
		(
			r_topic_id integer NULL,
			r_member_id integer NULL,
			r_last_message_time integer unsigned NOT NULL,
		...
		CREATE INDEX `f_custom_fields.cf_name` ON ocp6_f_custom_fields(cf_name);
		ALTER TABLE ocp6_f_custom_fields ADD FOREIGN KEY `f_custom_fields.cf_name` (cf_name) REFERENCES ocp6_translate (id);

		CREATE INDEX `f_custom_fields.cf_description` ON ocp6_f_custom_fields(cf_description);
		ALTER TABLE ocp6_f_custom_fields ADD FOREIGN KEY `f_custom_fields.cf_description` (cf_description) REFERENCES ocp6_translate (id);

		CREATE INDEX `f_forum_intro_ip.i_forum_id` ON ocp6_f_forum_intro_ip(i_forum_id);
		ALTER TABLE ocp6_f_forum_intro_ip ADD FOREIGN KEY `f_forum_intro_ip.i_forum_id` (i_forum_id) REFERENCES ocp6_f_forums (id);

		CREATE INDEX `f_forum_intro_member.i_forum_id` ON ocp6_f_forum_intro_member(i_forum_id);
		ALTER TABLE ocp6_f_forum_intro_member ADD FOREIGN KEY `f_forum_intro_member.i_forum_id` (i_forum_id) REFERENCES ocp6_f_forums (id);

		CREATE INDEX `f_forum_intro_member.i_member_id` ON ocp6_f_forum_intro_member(i_member_id);
		ALTER TABLE ocp6_f_forum_intro_member ADD FOREIGN KEY `f_forum_intro_member.i_member_id` (i_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_forum_tracking.r_forum_id` ON ocp6_f_forum_tracking(r_forum_id);
		ALTER TABLE ocp6_f_forum_tracking ADD FOREIGN KEY `f_forum_tracking.r_forum_id` (r_forum_id) REFERENCES ocp6_f_forums (id);

		CREATE INDEX `f_forum_tracking.r_member_id` ON ocp6_f_forum_tracking(r_member_id);
		ALTER TABLE ocp6_f_forum_tracking ADD FOREIGN KEY `f_forum_tracking.r_member_id` (r_member_id) REFERENCES ocp6_f_members (id);
		...
		CREATE INDEX `f_group_members.gm_group_id` ON ocp6_f_group_members(gm_group_id);
		ALTER TABLE ocp6_f_group_members ADD FOREIGN KEY `f_group_members.gm_group_id` (gm_group_id) REFERENCES ocp6_f_groups (id);

		CREATE INDEX `f_group_members.gm_member_id` ON ocp6_f_group_members(gm_member_id);
		ALTER TABLE ocp6_f_group_members ADD FOREIGN KEY `f_group_members.gm_member_id` (gm_member_id) REFERENCES ocp6_f_members (id);
		...
		CREATE INDEX `f_invites.i_inviter` ON ocp6_f_invites(i_inviter);
		ALTER TABLE ocp6_f_invites ADD FOREIGN KEY `f_invites.i_inviter` (i_inviter) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_member_cpf_perms.member_id` ON ocp6_f_member_cpf_perms(member_id);
		ALTER TABLE ocp6_f_member_cpf_perms ADD FOREIGN KEY `f_member_cpf_perms.member_id` (member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_member_cpf_perms.field_id` ON ocp6_f_member_cpf_perms(field_id);
		ALTER TABLE ocp6_f_member_cpf_perms ADD FOREIGN KEY `f_member_cpf_perms.field_id` (field_id) REFERENCES ocp6_f_custom_fields (id);

		CREATE INDEX `f_member_custom_fields.mf_member_id` ON ocp6_f_member_custom_fields(mf_member_id);
		ALTER TABLE ocp6_f_member_custom_fields ADD FOREIGN KEY `f_member_custom_fields.mf_member_id` (mf_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_member_custom_fields.field_1` ON ocp6_f_member_custom_fields(field_1);
		ALTER TABLE ocp6_f_member_custom_fields ADD FOREIGN KEY `f_member_custom_fields.field_1` (field_1) REFERENCES ocp6_translate (id);

		CREATE INDEX `f_member_custom_fields.field_4` ON ocp6_f_member_custom_fields(field_4);
		ALTER TABLE ocp6_f_member_custom_fields ADD FOREIGN KEY `f_member_custom_fields.field_4` (field_4) REFERENCES ocp6_translate (id);

		CREATE INDEX `f_member_custom_fields.field_7` ON ocp6_f_member_custom_fields(field_7);
		ALTER TABLE ocp6_f_member_custom_fields ADD FOREIGN KEY `f_member_custom_fields.field_7` (field_7) REFERENCES ocp6_translate (id);

		CREATE INDEX `f_member_known_login_ips.i_member_id` ON ocp6_f_member_known_login_ips(i_member_id);
		ALTER TABLE ocp6_f_member_known_login_ips ADD FOREIGN KEY `f_member_known_login_ips.i_member_id` (i_member_id) REFERENCES ocp6_f_members (id);
		...
		CREATE INDEX `f_moderator_logs.l_by` ON ocp6_f_moderator_logs(l_by);
		ALTER TABLE ocp6_f_moderator_logs ADD FOREIGN KEY `f_moderator_logs.l_by` (l_by) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_multi_moderations.mm_name` ON ocp6_f_multi_moderations(mm_name);
		ALTER TABLE ocp6_f_multi_moderations ADD FOREIGN KEY `f_multi_moderations.mm_name` (mm_name) REFERENCES ocp6_translate (id);

		CREATE INDEX `f_poll_answers.pa_poll_id` ON ocp6_f_poll_answers(pa_poll_id);
		ALTER TABLE ocp6_f_poll_answers ADD FOREIGN KEY `f_poll_answers.pa_poll_id` (pa_poll_id) REFERENCES ocp6_f_polls (id);

		CREATE INDEX `f_poll_votes.pv_poll_id` ON ocp6_f_poll_votes(pv_poll_id);
		ALTER TABLE ocp6_f_poll_votes ADD FOREIGN KEY `f_poll_votes.pv_poll_id` (pv_poll_id) REFERENCES ocp6_f_polls (id);

		CREATE INDEX `f_poll_votes.pv_member_id` ON ocp6_f_poll_votes(pv_member_id);
		ALTER TABLE ocp6_f_poll_votes ADD FOREIGN KEY `f_poll_votes.pv_member_id` (pv_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_poll_votes.pv_answer_id` ON ocp6_f_poll_votes(pv_answer_id);
		ALTER TABLE ocp6_f_poll_votes ADD FOREIGN KEY `f_poll_votes.pv_answer_id` (pv_answer_id) REFERENCES ocp6_f_poll_answers (id);

		CREATE INDEX `f_post_history.h_owner_member_id` ON ocp6_f_post_history(h_owner_member_id);
		ALTER TABLE ocp6_f_post_history ADD FOREIGN KEY `f_post_history.h_owner_member_id` (h_owner_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_post_history.h_alterer_member_id` ON ocp6_f_post_history(h_alterer_member_id);
		ALTER TABLE ocp6_f_post_history ADD FOREIGN KEY `f_post_history.h_alterer_member_id` (h_alterer_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_post_history.h_post_id` ON ocp6_f_post_history(h_post_id);
		ALTER TABLE ocp6_f_post_history ADD FOREIGN KEY `f_post_history.h_post_id` (h_post_id) REFERENCES ocp6_f_posts (id);

		CREATE INDEX `f_post_history.h_topic_id` ON ocp6_f_post_history(h_topic_id);
		ALTER TABLE ocp6_f_post_history ADD FOREIGN KEY `f_post_history.h_topic_id` (h_topic_id) REFERENCES ocp6_f_topics (id);
		...
		CREATE INDEX `f_read_logs.l_member_id` ON ocp6_f_read_logs(l_member_id);
		ALTER TABLE ocp6_f_read_logs ADD FOREIGN KEY `f_read_logs.l_member_id` (l_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_read_logs.l_topic_id` ON ocp6_f_read_logs(l_topic_id);
		ALTER TABLE ocp6_f_read_logs ADD FOREIGN KEY `f_read_logs.l_topic_id` (l_topic_id) REFERENCES ocp6_f_topics (id);

		CREATE INDEX `f_special_pt_access.s_member_id` ON ocp6_f_special_pt_access(s_member_id);
		ALTER TABLE ocp6_f_special_pt_access ADD FOREIGN KEY `f_special_pt_access.s_member_id` (s_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_special_pt_access.s_topic_id` ON ocp6_f_special_pt_access(s_topic_id);
		ALTER TABLE ocp6_f_special_pt_access ADD FOREIGN KEY `f_special_pt_access.s_topic_id` (s_topic_id) REFERENCES ocp6_f_topics (id);

		CREATE INDEX `f_topic_tracking.r_topic_id` ON ocp6_f_topic_tracking(r_topic_id);
		ALTER TABLE ocp6_f_topic_tracking ADD FOREIGN KEY `f_topic_tracking.r_topic_id` (r_topic_id) REFERENCES ocp6_f_topics (id);

		CREATE INDEX `f_topic_tracking.r_member_id` ON ocp6_f_topic_tracking(r_member_id);
		ALTER TABLE ocp6_f_topic_tracking ADD FOREIGN KEY `f_topic_tracking.r_member_id` (r_member_id) REFERENCES ocp6_f_members (id);
		...
		CREATE INDEX `f_warnings.w_member_id` ON ocp6_f_warnings(w_member_id);
		ALTER TABLE ocp6_f_warnings ADD FOREIGN KEY `f_warnings.w_member_id` (w_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_warnings.w_by` ON ocp6_f_warnings(w_by);
		ALTER TABLE ocp6_f_warnings ADD FOREIGN KEY `f_warnings.w_by` (w_by) REFERENCES ocp6_f_members (id);

		CREATE INDEX `f_warnings.p_silence_from_topic` ON ocp6_f_warnings(p_silence_from_topic);
		ALTER TABLE ocp6_f_warnings ADD FOREIGN KEY `f_warnings.p_silence_from_topic` (p_silence_from_topic) REFERENCES ocp6_f_topics (id);

		CREATE INDEX `f_warnings.p_silence_from_forum` ON ocp6_f_warnings(p_silence_from_forum);
		ALTER TABLE ocp6_f_warnings ADD FOREIGN KEY `f_warnings.p_silence_from_forum` (p_silence_from_forum) REFERENCES ocp6_f_forums (id);

		CREATE INDEX `f_warnings.p_changed_usergroup_from` ON ocp6_f_warnings(p_changed_usergroup_from);
		ALTER TABLE ocp6_f_warnings ADD FOREIGN KEY `f_warnings.p_changed_usergroup_from` (p_changed_usergroup_from) REFERENCES ocp6_f_groups (id);
