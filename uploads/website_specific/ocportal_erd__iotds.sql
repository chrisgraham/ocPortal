		...
		CREATE INDEX `iotd.i_title` ON ocp_iotd(i_title);
		ALTER TABLE ocp_iotd ADD FOREIGN KEY `iotd.i_title` (i_title) REFERENCES ocp_translate (id);

		CREATE INDEX `iotd.caption` ON ocp_iotd(caption);
		ALTER TABLE ocp_iotd ADD FOREIGN KEY `iotd.caption` (caption) REFERENCES ocp_translate (id);

		CREATE INDEX `iotd.submitter` ON ocp_iotd(submitter);
		ALTER TABLE ocp_iotd ADD FOREIGN KEY `iotd.submitter` (submitter) REFERENCES ocp_f_members (id);
