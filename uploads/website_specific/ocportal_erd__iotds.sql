		CREATE TABLE ocp10_iotd
		(
			id integer auto_increment NULL,
			url varchar(255) NOT NULL,
			i_title integer NOT NULL,
		...
		CREATE INDEX `iotd.i_title` ON ocp10_iotd(i_title);
		ALTER TABLE ocp10_iotd ADD FOREIGN KEY `iotd.i_title` (i_title) REFERENCES ocp10_translate (id);

		CREATE INDEX `iotd.caption` ON ocp10_iotd(caption);
		ALTER TABLE ocp10_iotd ADD FOREIGN KEY `iotd.caption` (caption) REFERENCES ocp10_translate (id);

		CREATE INDEX `iotd.submitter` ON ocp10_iotd(submitter);
		ALTER TABLE ocp10_iotd ADD FOREIGN KEY `iotd.submitter` (submitter) REFERENCES ocp10_f_members (id);
