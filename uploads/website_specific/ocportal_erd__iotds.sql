		...
		CREATE INDEX `iotd.i_title` ON ocp6_iotd(i_title);
		ALTER TABLE ocp6_iotd ADD FOREIGN KEY `iotd.i_title` (i_title) REFERENCES ocp6_translate (id);

		CREATE INDEX `iotd.caption` ON ocp6_iotd(caption);
		ALTER TABLE ocp6_iotd ADD FOREIGN KEY `iotd.caption` (caption) REFERENCES ocp6_translate (id);

		CREATE INDEX `iotd.submitter` ON ocp6_iotd(submitter);
		ALTER TABLE ocp6_iotd ADD FOREIGN KEY `iotd.submitter` (submitter) REFERENCES ocp6_f_members (id);
