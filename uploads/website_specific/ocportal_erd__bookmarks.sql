		...
		CREATE INDEX `bookmarks.b_owner` ON ocp10_bookmarks(b_owner);
		ALTER TABLE ocp10_bookmarks ADD FOREIGN KEY `bookmarks.b_owner` (b_owner) REFERENCES ocp10_f_members (id);
