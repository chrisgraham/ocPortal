		...
		CREATE INDEX `bookmarks.b_owner` ON ocp_bookmarks(b_owner);
		ALTER TABLE ocp_bookmarks ADD FOREIGN KEY `bookmarks.b_owner` (b_owner) REFERENCES ocp_f_members (id);
