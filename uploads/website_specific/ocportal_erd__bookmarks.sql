		...
		CREATE INDEX `bookmarks.b_owner` ON ocp6_bookmarks(b_owner);
		ALTER TABLE ocp6_bookmarks ADD FOREIGN KEY `bookmarks.b_owner` (b_owner) REFERENCES ocp6_f_members (id);
