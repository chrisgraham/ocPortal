		...
		CREATE TABLE ocp6_usersonline_track
		(
		...
		CREATE INDEX `stats.the_user` ON ocp6_stats(the_user);
		ALTER TABLE ocp6_stats ADD FOREIGN KEY `stats.the_user` (the_user) REFERENCES ocp6_f_members (id);
