		...
		CREATE TABLE ocp10_usersonline_track
		(
		...
		CREATE INDEX `stats.member_id` ON ocp10_stats(member_id);
		ALTER TABLE ocp10_stats ADD FOREIGN KEY `stats.member_id` (member_id) REFERENCES ocp10_f_members (id);
