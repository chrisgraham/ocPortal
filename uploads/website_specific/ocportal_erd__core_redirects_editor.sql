		...
		CREATE INDEX `redirects.r_from_zone` ON ocp4_redirects(r_from_zone);
		ALTER TABLE ocp4_redirects ADD FOREIGN KEY `redirects.r_from_zone` (r_from_zone) REFERENCES ocp4_zones (zone_name);

		CREATE INDEX `redirects.r_to_zone` ON ocp4_redirects(r_to_zone);
		ALTER TABLE ocp4_redirects ADD FOREIGN KEY `redirects.r_to_zone` (r_to_zone) REFERENCES ocp4_zones (zone_name);
