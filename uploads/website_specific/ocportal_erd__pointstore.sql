		...
		CREATE TABLE ocp10_pstore_customs
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp10_pstore_permissions
		(
			id integer auto_increment NULL,
		...
		CREATE INDEX `sales.memberid` ON ocp10_sales(memberid);
		ALTER TABLE ocp10_sales ADD FOREIGN KEY `sales.memberid` (memberid) REFERENCES ocp10_f_members (id);

		CREATE INDEX `pstore_customs.c_title` ON ocp10_pstore_customs(c_title);
		ALTER TABLE ocp10_pstore_customs ADD FOREIGN KEY `pstore_customs.c_title` (c_title) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_customs.c_description` ON ocp10_pstore_customs(c_description);
		ALTER TABLE ocp10_pstore_customs ADD FOREIGN KEY `pstore_customs.c_description` (c_description) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_customs.c_mail_subject` ON ocp10_pstore_customs(c_mail_subject);
		ALTER TABLE ocp10_pstore_customs ADD FOREIGN KEY `pstore_customs.c_mail_subject` (c_mail_subject) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_customs.c_mail_body` ON ocp10_pstore_customs(c_mail_body);
		ALTER TABLE ocp10_pstore_customs ADD FOREIGN KEY `pstore_customs.c_mail_body` (c_mail_body) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_permissions.p_title` ON ocp10_pstore_permissions(p_title);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_title` (p_title) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_permissions.p_description` ON ocp10_pstore_permissions(p_description);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_description` (p_description) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_permissions.p_mail_subject` ON ocp10_pstore_permissions(p_mail_subject);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_mail_subject` (p_mail_subject) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_permissions.p_mail_body` ON ocp10_pstore_permissions(p_mail_body);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_mail_body` (p_mail_body) REFERENCES ocp10_translate (id);

		CREATE INDEX `pstore_permissions.p_privilege` ON ocp10_pstore_permissions(p_privilege);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_privilege` (p_privilege) REFERENCES ocp10_privilege_list (the_name);

		CREATE INDEX `pstore_permissions.p_zone` ON ocp10_pstore_permissions(p_zone);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_zone` (p_zone) REFERENCES ocp10_zones (zone_name);

		CREATE INDEX `pstore_permissions.p_page` ON ocp10_pstore_permissions(p_page);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_page` (p_page) REFERENCES ocp10_modules (module_the_name);

		CREATE INDEX `pstore_permissions.p_category` ON ocp10_pstore_permissions(p_category);
		ALTER TABLE ocp10_pstore_permissions ADD FOREIGN KEY `pstore_permissions.p_category` (p_category) REFERENCES ocp10_anything (id);
