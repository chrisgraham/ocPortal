		CREATE TABLE ocp6_shopping_order
		(
		...
		CREATE TABLE ocp6_shopping_cart
		(
			id integer auto_increment NULL,
			session_id integer NOT NULL,
		...
		CREATE TABLE ocp6_shopping_order_details
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_shopping_logging
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp6_shopping_order_addresses
		(
			id integer auto_increment NULL,
			order_id integer NOT NULL,
		...
		CREATE INDEX `shopping_cart.ordered_by` ON ocp6_shopping_cart(ordered_by);
		ALTER TABLE ocp6_shopping_cart ADD FOREIGN KEY `shopping_cart.ordered_by` (ordered_by) REFERENCES ocp6_f_members (id);

		CREATE INDEX `shopping_cart.product_id` ON ocp6_shopping_cart(product_id);
		ALTER TABLE ocp6_shopping_cart ADD FOREIGN KEY `shopping_cart.product_id` (product_id) REFERENCES ocp6_catalogue_entries (id);

		CREATE INDEX `shopping_order_details.order_id` ON ocp6_shopping_order_details(order_id);
		ALTER TABLE ocp6_shopping_order_details ADD FOREIGN KEY `shopping_order_details.order_id` (order_id) REFERENCES ocp6_shopping_order (id);

		CREATE INDEX `shopping_order_details.p_id` ON ocp6_shopping_order_details(p_id);
		ALTER TABLE ocp6_shopping_order_details ADD FOREIGN KEY `shopping_order_details.p_id` (p_id) REFERENCES ocp6_catalogue_entries (id);

		CREATE INDEX `shopping_logging.e_member_id` ON ocp6_shopping_logging(e_member_id);
		ALTER TABLE ocp6_shopping_logging ADD FOREIGN KEY `shopping_logging.e_member_id` (e_member_id) REFERENCES ocp6_f_members (id);

		CREATE INDEX `shopping_order_addresses.order_id` ON ocp6_shopping_order_addresses(order_id);
		ALTER TABLE ocp6_shopping_order_addresses ADD FOREIGN KEY `shopping_order_addresses.order_id` (order_id) REFERENCES ocp6_shopping_order (id);
