		...
		CREATE TABLE ocp6_ticket_types
		(
		...
		CREATE INDEX `tickets.topic_id` ON ocp6_tickets(topic_id);
		ALTER TABLE ocp6_tickets ADD FOREIGN KEY `tickets.topic_id` (topic_id) REFERENCES ocp6_f_topics (id);

		CREATE INDEX `tickets.forum_id` ON ocp6_tickets(forum_id);
		ALTER TABLE ocp6_tickets ADD FOREIGN KEY `tickets.forum_id` (forum_id) REFERENCES ocp6_f_forums (id);

		CREATE INDEX `tickets.ticket_type` ON ocp6_tickets(ticket_type);
		ALTER TABLE ocp6_tickets ADD FOREIGN KEY `tickets.ticket_type` (ticket_type) REFERENCES ocp6_translate (id);

		CREATE INDEX `ticket_types.ticket_type` ON ocp6_ticket_types(ticket_type);
		ALTER TABLE ocp6_ticket_types ADD FOREIGN KEY `ticket_types.ticket_type` (ticket_type) REFERENCES ocp6_translate (id);
