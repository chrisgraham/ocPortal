		...
		CREATE INDEX `filedump.description` ON ocp6_filedump(description);
		ALTER TABLE ocp6_filedump ADD FOREIGN KEY `filedump.description` (description) REFERENCES ocp6_translate (id);

		CREATE INDEX `filedump.the_member` ON ocp6_filedump(the_member);
		ALTER TABLE ocp6_filedump ADD FOREIGN KEY `filedump.the_member` (the_member) REFERENCES ocp6_f_members (id);
