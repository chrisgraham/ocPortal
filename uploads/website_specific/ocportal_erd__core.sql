		...
		CREATE TABLE ocp10_comcode_pages
		(
		...
		CREATE TABLE ocp10_cached_comcode_pages
		(
			the_zone varchar(80) NULL,
			the_page varchar(80) NULL,
		...
		CREATE TABLE ocp10_members_mentors
		(
			member_id integer NULL,
			id integer auto_increment NULL,
		...
		CREATE TABLE ocp10_referees_qualified_for
		(
			id integer auto_increment NULL,
		...
		CREATE INDEX `comcode_pages.p_submitter` ON ocp10_comcode_pages(p_submitter);
		ALTER TABLE ocp10_comcode_pages ADD FOREIGN KEY `comcode_pages.p_submitter` (p_submitter) REFERENCES ocp10_f_members (id);

		CREATE INDEX `cached_comcode_pages.the_zone` ON ocp10_cached_comcode_pages(the_zone);
		ALTER TABLE ocp10_cached_comcode_pages ADD FOREIGN KEY `cached_comcode_pages.the_zone` (the_zone) REFERENCES ocp10_zones (zone_name);

		CREATE INDEX `cached_comcode_pages.string_index` ON ocp10_cached_comcode_pages(string_index);
		ALTER TABLE ocp10_cached_comcode_pages ADD FOREIGN KEY `cached_comcode_pages.string_index` (string_index) REFERENCES ocp10_translate (id);

		CREATE INDEX `cached_comcode_pages.cc_page_title` ON ocp10_cached_comcode_pages(cc_page_title);
		ALTER TABLE ocp10_cached_comcode_pages ADD FOREIGN KEY `cached_comcode_pages.cc_page_title` (cc_page_title) REFERENCES ocp10_translate (id);
		...
		CREATE INDEX `bank.member_id` ON ocp10_bank(member_id);
		ALTER TABLE ocp10_bank ADD FOREIGN KEY `bank.member_id` (member_id) REFERENCES ocp10_f_members (id);
		...
		CREATE INDEX `referees_qualified_for.q_referee` ON ocp10_referees_qualified_for(q_referee);
		ALTER TABLE ocp10_referees_qualified_for ADD FOREIGN KEY `referees_qualified_for.q_referee` (q_referee) REFERENCES ocp10_f_members (id);

		CREATE INDEX `referees_qualified_for.q_referrer` ON ocp10_referees_qualified_for(q_referrer);
		ALTER TABLE ocp10_referees_qualified_for ADD FOREIGN KEY `referees_qualified_for.q_referrer` (q_referrer) REFERENCES ocp10_f_members (id);
