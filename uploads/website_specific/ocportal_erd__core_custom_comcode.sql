		...
		CREATE INDEX `custom_comcode.tag_description` ON ocp4_custom_comcode(tag_description);
		ALTER TABLE ocp4_custom_comcode ADD FOREIGN KEY `custom_comcode.tag_description` (tag_description) REFERENCES ocp4_translate (id);

		CREATE INDEX `custom_comcode.tag_title` ON ocp4_custom_comcode(tag_title);
		ALTER TABLE ocp4_custom_comcode ADD FOREIGN KEY `custom_comcode.tag_title` (tag_title) REFERENCES ocp4_translate (id);
