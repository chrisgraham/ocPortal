...
*/
	...
	if (!function_exists('http_download_file'))
	{
		 ...
		 */
		function http_download_file($url,$byte_limit=NULL,$trigger_error=true,$no_redirect=false,$ua='ocPortal',$post=NULL,$cookies=NULL,$accept=NULL,$accept_charset=NULL,$accept_language=NULL,$write_to_file=NULL)
		{
			unset($byte_limit);
			unset($trigger_error);
			unset($no_redirect);
