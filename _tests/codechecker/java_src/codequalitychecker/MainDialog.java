...
public class MainDialog extends JFrame {
    ...
    private ArrayList<SearchFile> initiateFileSearch(String type, String path, String rec_subpath,
        ...
        for (i = 0; i < thefiles.length; i++) {
            ...
            if (tmpFile.isDirectory()) {
                if ((skip_custom) && (thefiles[i].contains("_custom"))) {
                    continue;
                }
    ...
    private ArrayList decompose_line(String line) {
        ArrayList decomposed = new ArrayList();
    ...
    private boolean line_skippable(String line) {
        ArrayList decomposed = decompose_line(line);
        ArrayList skip_decomposition;
