...
class template_test_set extends ocp_test_case
{
	...
	function setUp()
	{
		...
		$this->assertTrue('test_template'==$GLOBALS['FORUM_DB']->query_select_value('f_post_templates','t_title ',array('id'=>$this->template_id)));
	}
	...
	function testEditPostTemplate()
	{
		...
		// Test the forum was actually created
		$this->assertTrue('test_template2'==$GLOBALS['FORUM_DB']->query_select_value('f_post_templates','t_title ',array('id'=>$this->template_id)));
	}
