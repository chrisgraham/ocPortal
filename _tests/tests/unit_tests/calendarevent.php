...
class calendarevent_test_set extends ocp_test_case
{
	...
	function setUp()
	{
		...
		$this->event_id=add_calendar_event('','','',8,'1',NULL,0,'test_event','',3,1,2010,1,10,10,15,2010,NULL,1,1,19,11,15,1,1,1,1,'',NULL,0,NULL,NULL,NULL);
	...
	function testEditNewscategory()
	{
		...
		edit_calendar_event($this->event_id,'','','',8,'2',NULL,0,'test_event1','',3,1,2010,1,10,10,15,2010,NULL,1,1,19,11,15,'','',1,1,1,1,'');
		// Test the forum was actually created
