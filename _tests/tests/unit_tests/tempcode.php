...
class tempcode_test_set extends ocp_test_case
{
	function testTempcode()
	{
		...
		$tpl=do_template('tempcode_test',array('_GUID'=>'1f31d5279dd6a15a9fdba9296e1b7597','EMPTY1'=>'','EMPTY2'=>new ocp_tempcode(),'NONEMPTY'=>$nonempty,'PASSED'=>'This is a passed parameter','SIMPLE_ARRAY'=>array('1','2','3'),'ARRAY'=>array(array('a'=>'A1','b'=>'B1','c'=>'C1'),array('a'=>'A2','b'=>'B2','c'=>'C2'),array('a'=>'A3','b'=>'B3','c'=>'C3'),array('a'=>'A4','b'=>'B4','c'=>'C4'))));
		$got=$tpl->evaluate();
