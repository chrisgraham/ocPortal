	...
	function testLangMistakes()
	{
		...
		while (($file=readdir($dh))!==false)
		{
			...
			foreach($input as $key=>$string)
			{
				...
				if(($this->str_ipos($string,'email')!==false) && ($this->str_ipos($string,'/')===false)) $this->assertTrue(false,'The term \'email\' was used in '.$file.'. This should be changed to \'e-mail\'.');
				...
				if($this->str_ipos($string,'filedump')!==false) $this->assertTrue(false,'The term \'filedump\' was used in '.$file.'. This should be changed to \'file-dump\'.');
