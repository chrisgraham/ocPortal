...
<body class="re_body" id="main_website"{$?,{$VALUE_OPTION,html5}, itemscope="itemscope" itemtype="http://schema.org/WebPage"}>
	<div id="container">
		{+START,IF,{SHOW_TOP}}
			<ul class="top-bar">
				<li>
					<span class="text-size1"><a href="#" onclick="document.getElementById('container').style.fontSize='1em'; return false;">A</a></span>
					<span class="text-size2"><a href="#" onclick="document.getElementById('container').style.fontSize='1.2em'; return false;">A</a></span>
					<span class="text-size3"><a href="#" onclick="document.getElementById('container').style.fontSize='1.7em'; return false;">A</a></span>
				</li>

				<li>{$BLOCK,block=side_stored_menu,param=main_content,type=top}</li>
			</ul>

			<ul class="top-bar1">
				<li class="logo-part">
					<h2><a href="{$PAGE_LINK*,:start}">{$SITE_NAME*}</a></h2>
					<span>{$HEADER_TEXT*}</span>
				</li>
				<li class="search-box-wrap">{$BLOCK,block=main_search}</li>
			</ul>
