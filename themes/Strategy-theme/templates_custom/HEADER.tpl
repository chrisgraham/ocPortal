...
<body class="re_body" id="main_website"{$?,{$VALUE_OPTION,html5}, itemscope="itemscope" itemtype="http://schema.org/WebPage"}>
	<div id="wrapper">
		{+START,IF,{SHOW_TOP}}
			<div class="logo-part">
				<h4><a href="{$PAGE_LINK*,:start}">{$SITE_NAME*}</a><br /><span>{$HEADER_TEXT*}</span></h4>
				<div class="twitter"><a href="http://twitter.com/{$CONFIG_OPTION*,twitter_login}">Follow us on Twitter</a></div>
			</div>
