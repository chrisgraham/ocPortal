		...
		<div>
			{+START,IF,{$EQ,{INPUT_FIELDS},1}}
				<div class="constrain_field">
					<input class="search-box" onkeyup="update_ajax_search_list(this);" type="text" id="search_content" name="content" value="search" onfocus="if (this.value=='search') this.value='';" />
				</div>
			{+END}
