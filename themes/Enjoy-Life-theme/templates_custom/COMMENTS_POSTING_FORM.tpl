					...
					<div class="contact-form">
						<ul>
							...
							<li>
								...
								<textarea accesskey="x" class="wide_field" onfocus="if ((this.value=='{POST_WARNING^*;}' &amp;&amp; '{POST_WARNING^*;}'!='') || (typeof this.strip_on_focus!='undefined' &amp;&amp; this.value==this.strip_on_focus)) this.value=''; this.style.color='black';" cols="35" rows="11" name="post" id="post">{POST_WARNING*}</textarea>
							</li>
						</ul>
					</div>
				{+END}
