...
tree_list.prototype.handle_tree_click=function(event,automated) // Not called as a method
{
	...
	if (expanding)
	{
		...
		expand_button.src='{$IMG;,1x/treefield/collapse}'.replace(/^http:/,window.location.protocol);
	...
	} else
	{
		...
		expand_button.src='{$IMG;,1x/treefield/expand}'.replace(/^http:/,window.location.protocol);
