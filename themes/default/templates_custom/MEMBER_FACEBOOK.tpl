		...
		<table class="map_table wide_table ocf_profile_fields">
			...
			<tbody>
				<tr>
					...
					<td>
						<a rel="me" target="_blank" title="{$USERNAME*,{MEMBER_ID},1}'s Facebook {!LINK_NEW_WINDOW}" href="http://www.facebook.com/profile.php?id={$USER_FB_CONNECT*,{MEMBER_ID}}"><img alt="Facebook" src="{$IMG*,recommend/facebook}" /></a>
					</td>
				</tr>
			</tbody>
		</table>
