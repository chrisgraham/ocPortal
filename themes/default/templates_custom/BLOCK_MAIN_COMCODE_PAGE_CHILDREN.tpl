	...
	{+START,IF_ARRAY_NON_EMPTY,CHILDREN}
		...
		{+START,LOOP,CHILDREN}
			<div class="box"><div class="box_inner">
				{$SET,PAGE,{$PREG_REPLACE,<figure[^<>]*>.*</figure>,,{$PREG_REPLACE,<div class="box staff_actions">.*</div>,,{$PREG_REPLACE,Comments.*,,{$LOAD_PAGE,{PAGE},{ZONE},1}},s},Us}}
				...
				<p>
					<a class="buttons__goto button_screen_item" href="{$PAGE_LINK*,{ZONE}:{PAGE}}"><span>{!VIEW}</span></a>
				</p>
			</div></div>
		{+END}
	{+END}
