							...
							<table width="100%">
								<tr>
									<td style="text-align: left">
										{$FROM_TIMESTAMP,%d %B %Y\, %I:%M:%S %p,{$TO_TIMESTAMP,{TWEET_CREATED_AT}}} - {TWEET_TIME_AGO}
									</td>
									<td style="text-align: right">
										<a href="{REPLY_URL}" rel="nofollow"><img src="{$IMG,twitter_feed/reply}" id="{$GET,reply_id}" title="Reply to this Tweet" /></a> &nbsp;&nbsp;<a href="{RETWEET_URL}" rel="nofollow"><img src="{$IMG,twitter_feed/retweet}" id="{$GET,retweet_id}" title="Retweet this Tweet" /></a> &nbsp;&nbsp;<a href="{FAVORITE_URL}" rel="nofollow"><img src="{$IMG,twitter_feed/favorite}" id="{$GET,favorite_id}" title="Favorite this Tweet" /></a>
									</td>
								</tr>
							</table>
						</td>
