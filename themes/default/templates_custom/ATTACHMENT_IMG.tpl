...
<div class="lightbox_thumb medborder">
	<a rel="lightbox" target="_blank" onmouseover="this.setAttribute('title',this.getAttribute('title').replace(/ {!LINK_NEW_WINDOW;}$/,''));" title="{A_DESCRIPTION*} {!LINK_NEW_WINDOW}" href="{SCRIPT*}?id={ID*}{SUP_PARAMS*}{$KEEP*,0,1}&amp;for_session={$SESSION_HASHED*}"><img src="{SCRIPT*}?id={ID*}{SUP_PARAMS*}{$KEEP*,0,1}&amp;thumb={A_THUMB*}&amp;for_session={$SESSION_HASHED*}&amp;no_count=1" alt="{A_DESCRIPTION*}" title="{!IMAGE_ATTACHMENT,{$ATTACHMENT_DOWNLOADS*,{ID},{FORUM_DB_BIN}},{CLEAN_SIZE*}}" /></a>
</div>
