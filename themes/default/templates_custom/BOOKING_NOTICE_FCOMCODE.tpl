...
If there are any issues with this booking then it is important that you [url="alert the customer"]{$PAGE_LINK@,_SEARCH:topics:new_pt:{MEMBER_ID}}[/url] ([url="view their details"]{$PAGE_LINK@,_SEARCH:members:view:{MEMBER_ID}}[/url]).
