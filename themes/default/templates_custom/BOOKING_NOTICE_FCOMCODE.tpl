...
You can [url="edit the bookings for {$USERNAME@,{MEMBER_ID}}"]{$PAGE_LINK@,_SEARCH:cms_booking:eb:{MEMBER_ID},0,1}[/url].

If there are any issues with this booking then it is important that you [url="alert the customer"]{$PAGE_LINK@,_SEARCH:topics:new_pt:{MEMBER_ID},0,1}[/url] ([url="view their details"]{$PAGE_LINK@,_SEARCH:members:view:{MEMBER_ID},0,1}[/url]).
