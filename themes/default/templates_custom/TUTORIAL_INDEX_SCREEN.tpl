...
<ul>
	{+START,LOOP,TAGS}
		<li>
			<a href="{$PAGE_LINK*,_SEARCH:tutorials:{_loop_var}}">{_loop_var*}</a>
		</li>
	{+END}
</ul>
...
<h2>Need better information on {TAG_SELECTED*}?</h2>

<p>The ocPortal documentation is user-driven:</p>

<ul>
	<li>If you have found documentation problems that you'd like someone else to solve log an <a target="_blank" href="http://ocportal.com/tracker/set_project.php?project_id=7">issue to the tracker</a>.</li>
	<li>If you'd like to contribute a chunk of documentation to go into a tutorial, also log an <a target="_blank" href="http://ocportal.com/tracker/set_project.php?project_id=7">issue to the tracker</a>.</li>
