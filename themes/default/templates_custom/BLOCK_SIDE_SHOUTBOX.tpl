	...
	<form target="_self" action="{URL*}&amp;posted=1" method="post" title="{!SHOUTBOX}">
		...
		<div class="float_surrounder">
			<div style="width: 49%; float: left">
				<div class="constrain_field">
					<input onclick="window.top.setTimeout(function() { window.top.sb_chat_check(window.top.sb_last_message_id,-1); }, 2000); if (!check_field_for_blankness(this.form.elements['shoutbox_message'],event)) return false; disable_button_just_clicked(this); return true" type="submit" value="Send &uarr;" class="wide_button" />
				</div>
			</div>
