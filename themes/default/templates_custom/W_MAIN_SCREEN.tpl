...
<div class="ocw_centered_contents">
	...
	<div class="box box___w_main_screen">
		<h2 class="toggleable_tray_title">
			...
			{+START,IF,{$JS_ON}}
				<a class="toggleable_tray_button" href="#" onclick="return toggleable_tray(this.parentNode.parentNode); set_cookie('hideActions',(this.getElementsByTagName('img')[0].getAttribute('src')=='{$IMG;*,contract}')?'0':'1'); return false;"><img alt="{!EXPAND}" title="{!EXPAND}" src="{$IMG*,1x/trays/expand2}" srcset="{$IMG*,2x/trays/expand2} 2x" /></a>
			{+END}
		</h2>
	...
	{+START,IF,{MAY_DO_STUFF}}
		<div class="box box___w_main_screen">
			<h2 class="toggleable_tray_title">
				...
				{+START,IF,{$JS_ON}}
					<a class="toggleable_tray_button" href="#" onclick="return toggleable_tray(this.parentNode.parentNode); set_cookie('hideAdditions',(this.getElementsByTagName('img')[0].getAttribute('src')=='{$IMG;*,contract}')?'0':'1'); return false;"><img alt="{!EXPAND}" title="{!EXPAND}" src="{$IMG*,1x/trays/expand2}" srcset="{$IMG*,2x/trays/expand2} 2x" /></a>
				{+END}
			</h2>
	...
	<div class="box box___w_main_screen">
		<h2 class="toggleable_tray_title">
			...
			{+START,IF,{$JS_ON}}
				<a class="toggleable_tray_button" href="#" onclick="toggleable_tray(this.parentNode.parentNode); set_cookie('hideMod',(this.getElementsByTagName('img')[0].getAttribute('src')=='{$IMG;*,contract}')?'0':'1'); return false;"><img alt="{!EXPAND}" title="{!EXPAND}" src="{$IMG*,1x/trays/expand2}" srcset="{$IMG*,2x/trays/expand2} 2x" /></a>
			{+END}
		</h2>
