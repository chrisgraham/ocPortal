...
<div class="login_page">
	{+START,IF_NON_EMPTY,{$CONFIG_OPTION,facebook_appid}}
		{+START,IF_EMPTY,{$FB_CONNECT_UID}}
			...
			<div class="fb-login-button" data-width="200" data-max-rows="1" data-scope="email,user_birthday{+START,IF,{$CONFIG_OPTION,facebook_auto_syndicate}},publish_actions{+END}"></div>
		{+END}
