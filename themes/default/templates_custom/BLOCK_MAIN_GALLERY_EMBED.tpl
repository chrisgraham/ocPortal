...
<div id="carousel_{$GET*,carousel_id}" class="carousel" style="display: none">
	...
	<div class="move_right" onmousedown="carousel_move({$GET*,carousel_id},+47); return false;" onmouseover="this.className='move_right move_right_hover';" onmouseout="this.className='move_right';"></div>
