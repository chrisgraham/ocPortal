<tr>
	<th{+START,IF,{$NOT,{$VALUE_OPTION,html5}}} abbr="{!DETAILS}"{+END} style="vertical-align: top">
	...
	<td style="vertical-align: top">
		<a href="{BUG_REPORT_URL*}" target="_blank" title="{!CREATE_BUG_REPORT}: {ID*} {!LINK_NEW_WINDOW}">{!CREATE_BUG_REPORT}</a>
	</td>
</tr>
