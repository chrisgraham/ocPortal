...
<!--dc:title="{TRACKBACK_TITLE*}" -->
	...
	{+START,IF,{$JS_ON}}
		<div class="trackback_inside">
			&raquo;&nbsp;<a rel="nofollow" onclick="window.fauxmodal_alert('{!DONT_CLICK_TRACKBACK=;}'); return false;" href="{$FIND_SCRIPT*,trackback}?page={TRACKBACK_PAGE*}&amp;id={TRACKBACK_ID*}&amp;time={$FROM_TIMESTAMP}">{!TRACKBACK_LINK}</a>
		</div>
	{+END}
{+END}
