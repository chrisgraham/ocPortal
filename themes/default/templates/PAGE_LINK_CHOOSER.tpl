...
{+END}
	<div>
		...
		<script>// <![CDATA[
			new tree_list('{NAME*}','data/sitemap.php?get_perms=0{$KEEP;/}&start_links=1{+START,IF_PASSED,PAGE_TYPE}&page_type={PAGE_TYPE;/}{+END}{+START,IF_PASSED,CONTENT_CENTRIC}&content_centric=1{+END}','','',false,null,false,true);
		//]]></script>
