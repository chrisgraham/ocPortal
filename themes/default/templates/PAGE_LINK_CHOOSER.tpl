<form title="{!PRIMARY_PAGE_FORM}" action="{$BASE_URL*}/index.php" method="post">
	<div>
		...
		<script type="text/javascript">// <![CDATA[
			...
			var current_selection='{VALUE^;}';
			var site_tree=new tree_list('{NAME*}','data/site_tree.php?get_perms=0{$KEEP;}&start_links=1{+START,IF_PASSED,PAGE_TYPE}&page_type={PAGE_TYPE*}{+END}','','');
		//]]></script>
