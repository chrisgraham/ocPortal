...
{+END}
	<div>
		...
		<input onchange="{+START,IF_NON_PASSED,AS_FIELD}window.returnValue=this.value; if (typeof window.faux_close!='undefined') window.faux_close(); else window.close();{+END}{+START,IF_PASSED,AS_FIELD}this.value+=' '+this.selected_title;{+END}" style="display: none" type="text" id="{NAME*}" name="{NAME*}" value="{VALUE*}" />
