<td class="dottedborder_barrier_b_nonrequired sp_cell">
	...
	<select onclick="this.onchange();" onchange="permissions_overridden('access_{GROUP_ID%}');" onmouseover="if (this.options[this.selectedIndex].value=='-1') show_permission_setting(this,event);" tabindex="{TABINDEX*}" title="{TITLE*}" id="access_{GROUP_ID*}_sp_{SP*}" name="access_{GROUP_ID*}_sp_{SP*}">
