		...
		<div>
			{+START,IF,{$EQ,{INPUT_FIELDS},1}}
				<div class="constrain_field">
					...
					<input autocomplete="off" maxlength="255" class="wide_field" onkeyup="update_ajax_search_list(this,event);" type="search" id="search_content" name="content" value="" />
				</div>
			{+END}
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<input autocomplete="off" maxlength="255" {+START,IF,{$EQ,{_loop_key},content}}onkeyup="update_ajax_search_list(this,event);" {+END}type="text" id="search_{_loop_key*}" name="{_loop_key*}" value="" />
								</td>
							</tr>
						</tbody>
					</table></div>
