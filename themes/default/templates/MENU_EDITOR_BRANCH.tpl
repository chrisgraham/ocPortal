<div class="menu_editor_branch_wrap">
	...
	<ul class="actions_list">
		<li>
			<a rel="add" href="#" id="add_new_menu_linka_{I*}" onclick="return add_new_menu_item(this.id.substr(19),{CLICKABLE_SECTIONS*});"><img alt="" src="{$IMG*,1x/treefield/expand}" srcset="{$IMG*,2x/treefield/expand} 2x" /></a>
