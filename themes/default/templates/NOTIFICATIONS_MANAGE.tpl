				...
				<tr class="notification_code {$CYCLE*,zebra,zebra_0,zebra_1}">
					...
					<td class="associated_details">
						{+START,IF,{SUPPORTS_CATEGORIES}}
							<span class="associated_link"><a onclick="return open_link_as_overlay(this,null,null,'_self');" href="{$PAGE_LINK*,_SEARCH:notifications:advanced:notification_code={NOTIFICATION_CODE}{$?,{$NEQ,{MEMBER_ID},{$USER}},:keep_su={$USERNAME&,{MEMBER_ID}}}}">{!ADVANCED}</a></span>
						{+END}
					</td>
				</tr>
			{+END}
