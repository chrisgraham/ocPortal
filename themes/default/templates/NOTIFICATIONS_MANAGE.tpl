				...
				<tr class="notification_code {$CYCLE*,zebra,zebra_0,zebra_1}">
					...
					<td class="associated_details dottedborder_barrier_b_nonrequired">
						{+START,IF,{SUPPORTS_CATEGORIES}}
							[ <a onclick="return open_link_as_overlay(this,null,null,'_self');" href="{$PAGE_LINK*,_SEARCH:notifications:advanced:notification_code={NOTIFICATION_CODE}{$?,{$NEQ,{MEMBER_ID},{$USER}},:keep_su={$USERNAME&,{MEMBER_ID}}}}">{!ADVANCED}</a> ]
						{+END}
					</td>
				</tr>
			{+END}
