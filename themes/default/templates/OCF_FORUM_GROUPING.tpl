<div class="ocf_forum_grouping">
	<h3 class="toggleable_tray_title_heading">
		...
		<a class="toggleable_tray_button" href="#" onclick="return toggleable_tray('c_{GROUPING_ID;*}');">{+START,FRACTIONAL_EDITABLE,{GROUPING_TITLE},title,_SEARCH:admin_ocf_forum_groupings:__edit:{GROUPING_ID}}{GROUPING_TITLE*}{+END}</a>
		{+START,IF,{$HAS_ACTUAL_PAGE_ACCESS,admin_ocf_forum_groupings}}<span class="associated_details">(<a href="{$PAGE_LINK*,_SEARCH:admin_ocf_forum_groupings:_edit:{GROUPING_ID}}">{!EDIT}</a>)</span>{+END}
