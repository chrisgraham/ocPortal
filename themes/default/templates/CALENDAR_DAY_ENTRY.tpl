<div class="calendar_day_entry">
	<div class="float_surrounder">
		...
		<a title="{TITLE*}: #{ID*}" href="{URL*}" class="calendar_day_entry_title">{+START,FRACTIONAL_EDITABLE,{TITLE},title,_SEARCH:cms_calendar:type=__ed:id={ID}}{TITLE*}{+END}</a>{+START,IF,{RECURRING}} {!REPEAT_SUFFIX}{+END}
