...
<a title="{USERNAME*}" id="top_personal_stats_button" onclick="return toggle_top_personal_stats(event);" href="{$MEMBER_PROFILE_URL*,{MEMBER_ID}}"><img alt="" src="{$IMG*,icons/24x24/tabs/member_account/profile2}" srcset="{$IMG*,icons/48x48/tabs/member_account/profile2} 2x" /></a>
