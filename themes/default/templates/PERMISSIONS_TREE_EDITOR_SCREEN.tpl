	...
	<div class="box box___permissions_tree_editor_screen"><div class="box_inner">
		...
		<form id="permissions_form" title="{!PRIMARY_PAGE_FORM}" method="post" action="index.php">
			<div class="float_surrounder">
				...
				<div>
					<input type="button" class="buttons__save button_screen" id="selection_button" disabled="disabled" value="{!SET}" onclick="set_permissions(document.getElementById('tree_list'));" />
				</div>
			</div>
		</form>
	</div></div>
