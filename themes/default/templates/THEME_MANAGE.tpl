...
<tr{+START,IF,{$GET,done_one_theme}} class="thick_border"{+END}>
	...
	<td class="manage_theme_export">
		...
		{+END}
		<p><img alt="" src="{$IMG*,icons/24x24/tabs/preview}" srcset="{$IMG*,icons/48x48/tabs/preview} 2x" /> <a id="theme_preview__{NAME*}" target="_blank" title="{!PREVIEW} {!LINK_NEW_WINDOW}" href="{$PAGE_LINK*,::keep_theme={NAME}}">{!PREVIEW}</a></p>
