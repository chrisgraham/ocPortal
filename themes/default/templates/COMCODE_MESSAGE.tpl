<ul class="horizontal_links associated_links_block_group horiz_field_sep">
	...
	{+START,IF,{$AND,{$JS_ON},{W}}}
		<li><a rel="nofollow" id="toggle_wysiwyg_{NAME*}" href="#" onclick="return toggle_wysiwyg('{NAME;}');"><abbr title="{!comcode:TOGGLE_WYSIWYG_2}">{!comcode:ENABLE_WYSIWYG}</abbr></a></li>
	{+END}
</ul>
