<div class="comcode_supported">
	...
	<ul class="horizontal_links horiz_field_sep">
		{+START,IF,{$SHOW_DOCS}}{+START,IF_PASSED,URL}
			<li><a onclick="return open_link_as_overlay(this);" class="link_exempt" title="{!COMCODE_MESSAGE,Comcode} {!LINK_NEW_WINDOW}" target="_blank" href="{URL*}"><img src="{$IMG*,1x/editor/comcode}" srcset="{$IMG*,2x/editor/comcode} 2x" class="vertical_alignment" alt="" /></a></li>
		{+END}{+END}
