...
<div class="xhtml_validator_off">
	<iframe id="{$GET*,player_id}" src="http://player.vimeo.com/video/{REMOTE_ID*}?api=1" {+START,IF,{$_GET,slideshow}}autoplay="1" {+END}width="{WIDTH*}" height="{HEIGHT*}" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
</div>
