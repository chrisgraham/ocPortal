<div class="constrain_field">
	...
	<input autocomplete="off" maxlength="255" tabindex="{TABINDEX*}" class="{+START,IF,{NEEDS_MATCH}}input_username {+END}input_line{REQUIRED*} wide_field" onkeyup="update_ajax_member_list(this,null,false,event);" onchange="ensure_next_field(this);" onkeypress="ensure_next_field(this);" type="text" id="{NAME_STUB*}{I*}" name="{NAME_STUB*}{I*}" value="{DEFAULT*}" />
