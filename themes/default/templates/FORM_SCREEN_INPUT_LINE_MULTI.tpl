<div class="constrain_field">
	...
	<input {+START,IF_PASSED,MAXLENGTH}maxlength="{MAXLENGTH*}" {+END}tabindex="{TABINDEX*}" class="input_{CLASS*}{REQUIRED*}{+START,IF,{$NEQ,{CLASS},email}} wide_field{+END}" size="40" onkeypress="if (!key_pressed(event,9)) ensureNextField(this);" type="text" id="{$REPLACE,[],_,{NAME_STUB*}}{I*}" name="{NAME_STUB*}{+START,IF,{$NOT,{$IN_STR,{NAME_STUB},[]}}}{I*}{+END}" value="{DEFAULT*}" />
