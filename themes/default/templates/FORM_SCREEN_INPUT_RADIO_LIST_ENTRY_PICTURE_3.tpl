<div class="radio_list_picture">
	...
	<img style="margin: 1px" onkeypress="this.onclick(event);" id="{$FIX_ID*,j_{NAME}_{CODE}}_img" onclick="choose_picture('{$FIX_ID*;,j_{NAME}_{CODE}}',this,'{NAME*}',event);" class="inline_image" src="{URL*}" alt="{!SELECT_IMAGE}: {$STRIP_TAGS,{CODE*}}" title="" />
</div>
