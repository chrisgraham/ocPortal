<ul class="actions_list" role="navigation">
	<li class="actions_list_strong">
		...
		{+START,IF_NON_EMPTY,{CLEAN_FILESIZE}{$GET,num_downloads}}
			{+START,SET,num_downloads}{+START,IF_PASSED,NUM_DOWNLOADS}{+START,IF_NON_PASSED_OR_FALSE,WYSIWYG_SAFE}{+START,IF,{$INLINE_STATS}}{!DOWNLOADS_SO_FAR,{NUM_DOWNLOADS*}}{+END}{+END}{+END}{+END}
