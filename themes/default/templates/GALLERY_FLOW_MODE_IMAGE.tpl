			...
			<section class="box box___gallery_flow_mode_image"><div class="box_inner">
				...
				<table class="map_table results_table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a rel="author" href="{$MEMBER_PROFILE_URL*,{SUBMITTER}}" itemprop="author">{$USERNAME*,{SUBMITTER},1}</a></td>
						</tr>
				...
				<ul class="horizontal_links associated_links_block_group">
					{+START,IF,{$ADDON_INSTALLED,recommend}}
						<li><img src="{$IMG*,icons/16x16/filetypes/email_link}" srcset="{$IMG*,icons/16x16/filetypes/email_link} 2x" alt="" /> <a href="{$PAGE_LINK*,:recommend:misc:subject={!ECARD_FOR_YOU_SUBJECT}:page_title={!SEND_AS_ECARD}:s_message={!ECARD_FOR_YOU,{$SELF_URL},{FULL_URL*},{$SITE_NAME}}}">{!SEND_AS_ECARD}</a></li>
					{+END}
