...
{+START,IF_NON_EMPTY,{CODE}}
	<div class="float_surrounder">
		<div class="float_surrounder">
			<a class="toggleable_tray_button ttb_left" title="{!VIEW_SOURCE_CODE}" href="#" onclick="return toggleable_tray('{CLASS;*}.{FUNCTION;*}');"><img alt="{!EXPAND}: {!VIEW_SOURCE_CODE}" title="{!EXPAND}" src="{$IMG*,1x/trays/expand}" srcset="{$IMG*,2x/trays/expand} 2x" /></a>
		</div>
