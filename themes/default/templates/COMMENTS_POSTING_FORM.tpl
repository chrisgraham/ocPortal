						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<div class="constrain_field">
										<textarea{+START,IF,{$NOT,{$MOBILE}}} onkeyup="manageScrollHeight(this);"{+END} accesskey="x" class="wide_field" onfocus="if ((this.value=='{POST_WARNING^*;}') &amp;&amp; ('{POST_WARNING^*;}'!='')) this.value=''; this.style.color='black';" cols="42" rows="11" name="post" id="post">{POST_WARNING*}</textarea>
									</div>
