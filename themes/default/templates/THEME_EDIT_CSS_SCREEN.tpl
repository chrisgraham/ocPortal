...
<div class="float_surrounder">
	<div style="display: none" id="selectors">
		...
		<div class="css_editor_selector_tips lightborder">
			...
			<table summary="{!COLUMNED_TABLE}" class="reference" cellspacing="0" cellpadding="0" border="1" width="100%">
				<tbody><tr>
				...
				<tr>
					<td><a target="_blank" title="background {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/css3_pr_background.asp">background</a></td>
