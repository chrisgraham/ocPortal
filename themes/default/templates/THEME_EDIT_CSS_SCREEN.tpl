			...
			<div>
				...
				<div class="toggleable_tray" style="display: {$JS_ON,none,block}" aria-expanded="false">
					<table class="columned_table results_table" cellspacing="0" cellpadding="0" border="1" width="100%">
						...
						<tr>
							<td><a target="_blank" title="background {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_background.asp">background</a></td>
							<td>Sets all the background properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="background-color {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_background-color.asp">background-color</a></td>
							<td>Sets the background color of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="background-image {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_background-image.asp">background-image</a></td>
							<td>Sets the background image for an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="background-position {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_background-position.asp">background-position</a></td>
							<td>Sets the starting position of a background image</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="background-repeat {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_background-repeat.asp">background-repeat</a></td>
			...
			<div>
				...
				<div class="toggleable_tray" style="display: {$JS_ON,none,block}" aria-expanded="false">
					<table class="columned_table results_table" cellspacing="0" cellpadding="0" border="1" width="100%">
						...
						<tr>
							<td><a target="_blank" title="border {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border.asp">border</a></td>
							<td>Sets all the border properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="border-bottom {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border-bottom.asp">border-bottom</a></td>
							<td>Sets all the bottom border properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="border-color {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border-color.asp">border-color</a></td>
							<td>Sets the color of the four borders</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="border-left {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border-left.asp">border-left</a></td>
							<td>Sets all the left border properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="border-right {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border-right.asp">border-right</a></td>
							<td>Sets all the right border properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="border-style {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border-style.asp">border-style</a></td>
							<td>Sets the style of the four borders</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="border-top {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border-top.asp">border-top</a></td>
							<td>Sets all the top border properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="border-width {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_border-width.asp">border-width</a></td>
			...
			<div>
				...
				<div class="toggleable_tray" style="display: {$JS_ON,none,block}" aria-expanded="false">
					<table class="columned_table results_table" cellspacing="0" cellpadding="0" border="1" width="100%">
						...
						<tr>
							<td><a target="_blank" title="height {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_dim_height.asp">height</a></td>
							<td>Sets the height of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="max-height {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_dim_max-height.asp">max-height</a></td>
							<td>Sets the maximum height of an element</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="max-width {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_dim_max-width.asp">max-width</a></td>
							<td>Sets the maximum width of an element</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="min-height {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_dim_min-height.asp">min-height</a></td>
							<td>Sets the minimum height of an element</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="min-width {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_dim_min-width.asp">min-width</a></td>
							<td>Sets the minimum width of an element</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="width {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_dim_width.asp">width</a></td>
			...
			<div>
				...
				<div class="toggleable_tray" style="display: {$JS_ON,none,block}" aria-expanded="false">
					<table class="columned_table results_table" cellspacing="0" cellpadding="0" border="1" width="100%">
						...
						<tr>
							<td><a target="_blank" title="list-style {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_list-style.asp">list-style</a></td>
							<td>Sets all the properties for a list in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="list-style-type {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_list-style-type.asp">list-style-type</a></td>
			...
			<div>
				...
				<div class="toggleable_tray" style="display: {$JS_ON,none,block}" aria-expanded="false">
					<table class="columned_table results_table" cellspacing="0" cellpadding="0" border="1" width="100%">
						...
						<tr>
							<td><a target="_blank" title="margin {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_margin.asp">margin</a></td>
							<td>Sets all the margin properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="margin-bottom {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_margin-bottom.asp">margin-bottom</a></td>
							<td>Sets the bottom margin of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="margin-left {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_margin-left.asp">margin-left</a></td>
							<td>Sets the left margin of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="margin-right {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_margin-right.asp">margin-right</a></td>
							<td>Sets the right margin of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="margin-top {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_margin-top.asp">margin-top</a></td>
							<td>Sets the top margin of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="padding {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_padding.asp">padding</a></td>
							<td>Sets all the padding properties in one declaration</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="padding-bottom {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_padding-bottom.asp">padding-bottom</a></td>
							<td>Sets the bottom padding of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="padding-left {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_padding-left.asp">padding-left</a></td>
							<td>Sets the left padding of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="padding-right {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_padding-right.asp">padding-right</a></td>
							<td>Sets the right padding of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="padding-top {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_padding-top.asp">padding-top</a></td>
			...
			<div>
				...
				<div class="toggleable_tray" style="display: {$JS_ON,none,block}" aria-expanded="false">
					<table class="columned_table results_table" cellspacing="0" cellpadding="0" border="1" width="100%">
						...
						<tr>
							<td><a target="_blank" title="bottom {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_pos_bottom.asp">bottom</a></td>
							<td>Sets the bottom margin edge for a positioned box</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="clear {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_class_clear.asp">clear</a></td>
							<td>Specifies which sides of an element where other floating elements are not allowed</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="display {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_class_display.asp">display</a></td>
							<td>Specifies the type of box an element should generate</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="float {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_class_float.asp">float</a></td>
							<td>Specifies whether or not a box should float</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="left {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_pos_left.asp">left</a></td>
							<td>Sets the left margin edge for a positioned box</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="overflow {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_pos_overflow.asp">overflow</a></td>
							<td>Specifies what happens if content overflows an element's box</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="position {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_class_position.asp">position</a></td>
							<td>Specifies the type of positioning for an element</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="right {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_pos_right.asp">right</a></td>
							<td>Sets the right margin edge for a positioned box</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="top {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_pos_top.asp">top</a></td>
							<td>Sets the top margin edge for a positioned box</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="visibility {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_class_visibility.asp">visibility</a></td>
							<td>Specifies whether or not an element is visible</td>
							<td>2</td>
						</tr>
						<tr>
							<td><a target="_blank" title="z-index {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_pos_z-index.asp">z-index</a></td>
			...
			<div>
				...
				<div class="toggleable_tray" style="display: {$JS_ON,none,block}" aria-expanded="false">
					<table class="columned_table results_table" cellspacing="0" cellpadding="0" border="1" width="100%">
						...
						<tr>
							<td><a target="_blank" title="font-family {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_font_font-family.asp">font-family</a></td>
							<td>Specifies the font family for text</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="font-size {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_font_font-size.asp">font-size</a></td>
							<td>Specifies the font size of text</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="font-style {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_font_font-style.asp">font-style</a></td>
							<td>Specifies the font style for text</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="font-weight {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_font_weight.asp">font-weight</a></td>
							<td>Specifies the weight of a font</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="color {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_text_color.asp">color</a></td>
							<td>Sets the color of text</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="line-height {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_dim_line-height.asp">line-height</a></td>
							<td>Sets the line height</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="text-align {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_text_text-align.asp">text-align</a></td>
							<td>Specifies the horizontal alignment of text</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="text-decoration {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_text_text-decoration.asp">text-decoration</a></td>
							<td>Specifies the decoration added to text</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="text-transform {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_text_text-transform.asp">text-transform</a></td>
							<td>Controls the capitalisation of text</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="vertical-align {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_pos_vertical-align.asp">vertical-align</a></td>
							<td>Sets the vertical alignment of an element</td>
							<td>1</td>
						</tr>
						<tr>
							<td><a target="_blank" title="white-space {!LINK_NEW_WINDOW}" href="http://www.w3schools.com/css/pr_text_white-space.asp">white-space</a></td>
...
<form title="{!PRIMARY_PAGE_FORM}" action="{URL*}" method="post">
	<div>
		...
		<div class="float_surrounder buttons_group">
			<div class="right">
				<input id="save_button" onclick="disable_button_just_clicked(this); this.form.target='_self'; this.form.action='{URL;*}';" class="buttons__save button_page" type="submit" value="{!SAVE}" />
			</div>
			{+START,IF,{$JS_ON}}
				<div class="right">
					<input onclick="disable_button_just_clicked(this); this.form.target='save_frame'; this.form.action='{URL;*}{$?,{$IN_STR,{URL},?},&amp;,?}save_and_stay=1';" class="buttons__save_and_stay button_page" type="submit" accesskey="U" value="{!SAVE_AND_STAY}" />
				</div>
			{+END}
		</div>
	</div>
	...
	<section class="box"><div class="box_inner">
		...
		<form title="{!CSS_EQUATION_HELPER}" action="{$BASE_URL*}/index.php" onsubmit="return false;" method="post">
			<p>
				...
				<input onclick="cancel_bubbling(event,this); var result=load_snippet('themewizard_equation&amp;theme={THEME;*}&amp;css_equation='+window.encodeURIComponent(document.getElementById('css_equation').value),false); if (result=='' || result.indexOf('&lt;html')!=-1) window.fauxmodal_alert('{!ERROR_OCCURRED;}'); else document.getElementById('css_result').value=result; return false;" class="buttons__calculate button_pageitem" type="submit" value="{!CALCULATE}" />
