...
<div class="box ocf_notification"><div class="box_inner">
	<p>
		{!NEW_PT_NOTIFICATION_DETAILS,<span class="ocf_notification_type">{TYPE*}</span>,{U_TITLE*},{$?,{$IS_EMPTY,{PROFILE_URL}},{BY*},<a href="{PROFILE_URL*}">{BY*}</a>},{TIME*}}
	</p>
	...
	<ul class="horizontal_links associated_links_block_group force_margin">
		...
		<li><a onclick="return ignore_ocf_notification('{IGNORE_URL_2*;}',this);" href="{IGNORE_URL*}" title="{!IGNORE}: {!FORUM_POST} #{ID*}">{!IGNORE}</a></li>
	</ul>
</div></div>
