<section class="box box___block_main_bottom_bar pale_box"><div class="box_inner">
	...
	<div class="wide_table_wrap"><table class="map_table ocf_stats_table wide_table">
		{+START,IF,{$NOT,{$MOBILE}}}
			<colgroup>
			...
			{+START,IF_NON_EMPTY,{USERS_ONLINE}}
				<tr>
					<th class="de_th ocf_stats_usersonline_1">
						...
						{+START,IF_NON_EMPTY,{USERS_ONLINE_URL}}<p class="associated_link associated_links_block_group"><a href="{USERS_ONLINE_URL*}">{!DETAILS}</a></p>{+END}
					</th>
