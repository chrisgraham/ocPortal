...
<span class="vertical_alignment">
	...
	{+START,IF,{$JS_ON}}<button class="button_micro" type="button" id="clearBtn_{NAME_STUB*}{I*}" onclick="var x=document.getElementById('{NAME_STUB*}{I*;}'); x.value=''; if (typeof x.fakeonchange!='undefined' &amp;&amp; x.fakeonchange) x.fakeonchange(event); return false;">{!CLEAR}</button>{+END}
