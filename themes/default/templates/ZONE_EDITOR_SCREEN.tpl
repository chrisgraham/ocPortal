...
<div class="float_surrounder" id="ze_panels_wrap">
	<div id="p_panel_left" class="ze_panel" onmouseover="this.className='ze_panel ze_panel_expanded'; if (!this.style.width) this.style.width='16em'; ze_animate_to(this,38,true);" onmouseout="this.className='ze_panel'; if (!this.style.width) this.style.width='38em'; ze_animate_to(this,16,false);">
		{LEFT_EDITOR}
	</div>

	<div id="p_panel_right" class="ze_panel" onmouseover="this.className='ze_panel ze_panel_expanded'; if (!this.style.width) this.style.width='16em'; ze_animate_to(this,38,true);" onmouseout="this.className='ze_panel'; if (!this.style.width) this.style.width='38em'; ze_animate_to(this,16,false);">
		{RIGHT_EDITOR}
	</div>
