...
{+START,BOX,{!CHARGE_USER},,light}
	...
	<form title="{!CHARGE_USER}" method="post" onsubmit="return checkForm(this);" action="{URL*}">
		<div>
			...
			<p class="points_page_field_wrap"><label for="charge_amount"><input maxlength="10" id="charge_amount" class="input_integer_required" value="" type="text" name="amount" />{!AMOUNT}</label>: </p>
