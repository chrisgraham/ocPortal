	...
	<div class="bottom_under">
		<div class="global_bottom">
			...
			{+START,IF,{$ADDON_INSTALLED,bookmarks}}{+START,IF,{$NOT,{$IS_GUEST}}}
				<span class="global_bottom_button_ref_point" id="bookmarks_menu_rel">&nbsp;</span><a accesskey="n" id="bookmarks_menu_button" onclick="if (typeof window.load_management_menu!='undefined') return load_management_menu('bookmarks'); else return false;" href="{$PAGE_LINK*,_SEARCH:bookmarks}&amp;url={$SELF_URL*&}"><img id="bookmarks_menu_img" class="no_theme_img_click" title="{!BOOKMARKS}" alt="{!BOOKMARKS}" src="{$IMG*,bottom/bookmarksmenu}" /></a>&nbsp;
			{+END}{+END}
