<div class="menu_editor_branch" id="branch_wrap_{I*}">
	<div id="branch_{I*}">
		...
		<input type="hidden" id="include_sitemap_{I*}" name="include_sitemap_{I*}" value="0" />
		...
		<input class="menu___generic_admin__delete horiz_field_sep button_pageitem" value="{!DELETE}" type="button" id="del_{I*}" name="del_{I*}" onclick="delete_menu_branch(this);" />
	</div>
