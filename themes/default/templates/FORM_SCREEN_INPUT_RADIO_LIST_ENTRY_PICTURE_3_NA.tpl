<div class="radio_list_picture">
	...
	<img style="margin: 1px" onkeypress="this.onclick(event);" id="{$FIX_ID*,j_{NAME}_}_img" onclick="choose_picture('{$FIX_ID*;,j_{NAME}_}',this,'{NAME*}');" class="inline_image" src="{$IMG*,ocf_emoticons/none}" alt="{!SELECT_IMAGE}: {!NA}" title="" />
</div>
