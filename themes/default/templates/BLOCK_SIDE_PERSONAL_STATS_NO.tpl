			...
			<div>
				...
				<div class="login_block_cookies">
					<div class="float_surrounder">
						...
						<input {+START,IF,{$CONFIG_OPTION,remember_me_by_default}}checked="checked" {+END}{+START,IF,{$NOT,{$CONFIG_OPTION,remember_me_by_default}}}onclick="if (this.checked) if (!window.confirm('{!REMEMBER_ME_COOKIE;}')) this.checked=false;" {+END}type="checkbox" value="1" id="s_remember" name="remember" />
					</div>
