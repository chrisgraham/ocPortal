	...
	<div class="site_special_message_alt_inner">
		...
		<form title="{!PROCEED}" action="{URL*}" method="post">
			{+START,IF_NON_EMPTY,{ANSWER}}
				<div class="ocf_intro_question_answer_box"><label for="answer">{!ANSWER}</label>: <input maxlength="255" id="answer" value="" type="text" name="answer" /> <input accesskey="u" onclick="disable_button_just_clicked(this);" class="buttons__proceed button_screen" type="submit" value="{!PROCEED}" /></div>
			{+END}
