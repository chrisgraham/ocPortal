	...
	<tbody>
		<tr>
			<th class="form_table_field_name vertical_alignment">
				...
				{+START,IF,{$NOT,{$MOBILE}}}
					<img class="help_icon" onclick="this.onmouseover(event);" title="{!ATTACHMENT_HELP_2=,{$GET,IMAGE_TYPES}}" onmouseover="activate_rich_semantic_tooltip(this,event);" alt="{!HELP}" src="{$IMG*,icons/16x16/help}" srcset="{$IMG*,icons/32x32/help} 2x" />
				{+END}
			</th>
