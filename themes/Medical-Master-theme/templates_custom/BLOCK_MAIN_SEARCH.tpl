		...
		<div>
			{+START,IF,{$EQ,{INPUT_FIELDS},1}}
				<div class="constrain_field">
					<input class="text-input" onkeyup="update_ajax_search_list(this);" type="text" id="search_content" name="content" value="" />
				</div>
			{+END}
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<input {+START,IF,{$EQ,{_loop_key},content}}onkeyup="update_ajax_search_list(this);" {+END}type="text" id="search_{_loop_key*}" class="text-input" name="{_loop_key*}" value="" />
								</td>
							</tr>
						</tbody>
					</table></div>
