	...
	<div class="float_surrounder">
		<div class="ocf_profile_column">
			...
			{+START,IF_NON_EMPTY,{ACTIONS_views}{ACTIONS_profile}}
				<div>
					<h2>
						<a class="hide_button" href="#" onclick="event.returnValue=false; hideTag(this.parentNode.parentNode); return false;"><img alt="{!EXPAND}: {!PERSONAL_ZONE}" title="{!EXPAND}" src="{$IMG*,expand}" /></a>
