...
<body class="re_body" id="main_website"{$?,{$VALUE_OPTION,html5}, itemscope="itemscope" itemtype="http://schema.org/WebPage"}>
	{+START,IF,{SHOW_TOP}}
		<div id="top-bar">
			<div id="top-bar-in">
				<span><a href="{$PAGE_LINK*,:start}"><img src="{$IMG*,logo}" alt="{$SITE_NAME*}" /></a></span>
			...
			<div id="banner-in">
				...
				<div id="login">
					<ul>
						...
						<li>{$BLOCK,block=side_personal_stats}</li>
					</ul>
				</div>
				<div class="line-vertical"> </div>
				<div id="gift">
					<ul>
						<li><h1>Sign up for<br />Great Offers</h1></li>
						<li>{$BLOCK,block=main_newsletter_signup}</li>
					</ul>
				</div>
			</div>
		</div>
