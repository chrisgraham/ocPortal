<div class="box1 standardbox_wrap_classic" style="{+START,IF,{$AND,{$NEQ,{WIDTH},100%},{$NOT,{$BROWSER_MATCHES,ie}}}}width: {WIDTH'}{+END}">
	<div {+START,IF_NON_EMPTY,{TITLE}}id="{TITLE|}" {+END}class="standardbox_classic" style="height: {HEIGHT'}; width: {WIDTH'}">
		{+START,IF_NON_EMPTY,{TITLE}}
			<h3 class="standardbox_title_classic head">
