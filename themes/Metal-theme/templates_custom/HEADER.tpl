	...
	<div id="header">
		<div id="container">
			{+START,IF,{SHOW_TOP}}
				<div id="header-in">
					<ul>
						<li class="logo"><a href="{$PAGE_LINK*,:start}"><img src="{$IMG*,logo}" alt="{$SITE_NAME*}" /></a></li>
						<li class="search">{$BLOCK,block=main_search}</li>
					</ul>
				</div>
			{+END}
		 	...
		 	<div id="container1">
				...
				<div id="content" class="page_running_{$PAGE*}">
