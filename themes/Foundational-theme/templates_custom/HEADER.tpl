...
<body class="re_body" id="main_website"{$?,{$VALUE_OPTION,html5}, itemscope="itemscope" itemtype="http://schema.org/WebPage"}>
	{+START,IF,{SHOW_TOP}}
		<div id="top-banner">
			<div>
				<div id="site_name">
					<h1><a href="{$PAGE_LINK*,:start}">{$SITE_NAME*}</a></h1>
					<br />
					<h4>{$HEADER_TEXT*}</h4>
				</div>
				...
				<div class="header-list">
					<ul>
						<li><a href="{$PAGE_LINK*,:about}">Accountability</a></li>
						<li><a href="{$PAGE_LINK*,:about}">Knowledge</a></li>
						<li><a href="{$PAGE_LINK*,:about}">Equality</a></li>
					</ul>
				</div>
			</div>
		</div>
