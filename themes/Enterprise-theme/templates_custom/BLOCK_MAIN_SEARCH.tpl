<form onsubmit="if (typeof this.elements['contents']=='undefined') { disable_button_just_clicked(this); return true; } if (checkFieldForBlankness(this.elements['contents'],event)) { return true; } return false;" action="{$URL_FOR_GET_FORM*,{URL}}" method="get" class="inline">
