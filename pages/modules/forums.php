...
class Module_forums
{
	...
	function run()
	{
		...
		$access_url=get_param('url',$base_url.'/');
		...
		return do_template('COMCODE_SURROUND',array('_GUID'=>'4d5a8ce37df94f7d61f1a96f5689b9c0','CLASS'=>'float_surrounder','CONTENT'=>protect_from_escaping(reprocess_url($access_url,$base_url))));
	}
