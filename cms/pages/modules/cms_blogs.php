...
class Module_cms_blogs extends standard_crud_module
{
	...
	function import_wordpress()
	{
		...
		$xml_upload_form=do_template('FORM',array('_GUID'=>'bdcc111acf379bab6f163f2e86d20e03','TABINDEX'=>strval(get_form_field_tabindex()),'TEXT'=>'','HIDDEN'=>$hidden,'FIELDS'=>$fields,'SUBMIT_NAME'=>$submit_name,'URL'=>$xml_post_url));
