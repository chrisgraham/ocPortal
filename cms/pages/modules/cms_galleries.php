...
class Module_cms_galleries extends standard_crud_module
{
	...
	{
		$ret=array(
			'misc'=>array('MANAGE_GALLERIES','menu/cms/galleries/galleries'),
	...
	function gimp()
	{
		...
		return do_template('FORM_SCREEN',array('_GUID'=>'5213edb75c8d534c121b587c555a3b9a','TITLE'=>$this->title,'SKIP_VALIDATION'=>true,'GET'=>true,'HIDDEN'=>'','TEXT'=>'','FIELDS'=>$fields,'URL'=>$post_url,'SUBMIT_NAME'=>$submit_name));
	}
	...
	function _gimp()
	{
		...
		if (($GLOBALS['FORUM_DRIVER']->is_staff(get_member())) && ($GLOBALS['SITE_DB']->query_select_value('images','COUNT(*)')+$GLOBALS['SITE_DB']->query_select_value('videos','COUNT(*)')<4000))
		{
			...
			if (!$orphaned_content->is_empty())
			{
				...
				$form2=do_template('FORM',array('_GUID'=>'79c9fd4f29197460f08443bf2ffdf8b2','SECONDARY_FORM'=>true,'TABINDEX'=>strval(get_form_field_tabindex()),'FIELDS'=>$fields_2,'SUBMIT_NAME'=>do_lang_tempcode('PROCEED'),'URL'=>$add_url,'TEXT'=>'','HIDDEN'=>$hidden_2));
