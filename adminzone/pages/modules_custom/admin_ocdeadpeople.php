...
class Module_admin_ocdeadpeople extends Standard_crud_module
{
    ...
    public $menu_label = 'OCDEADPEOPLE_TITLE';
    public $do_preview = null;
    public $view_entry_point = '_SEARCH:admin_ocdeadpeople:view:_ID';
    ...
    {
        return array(
            'browse' => array('MANAGE_DISEASES', 'menu/ocdeadpeople_log'),
    ...
    public function pre_run($top_level = true, $type = null)
    {
        ...
        if ($type == 'view') {
            breadcrumb_set_parents(array(array('_SELF:_SELF:browse', do_lang_tempcode('OCDEADPEOPLE_TITLE'))));
