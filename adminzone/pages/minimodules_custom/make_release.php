...
function phase_2()
{
	...
	if ((!$is_bleeding_edge) && (!$is_old_tree))
	{
		...
		echo '
			...
			<li><strong>Other integrations</strong>: E-mail <a href="mailto:?bcc=punit@softaculous.com,brijesh@softaculous.com&amp;subject=New ocPortal release&amp;body=Hi, this is an automated notification that a new release of ocPortal has been released - regards, the ocPortal team.">integration partners</a></li>
