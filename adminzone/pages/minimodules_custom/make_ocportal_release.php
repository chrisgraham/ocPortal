...
$releases_category_id=$GLOBALS['SITE_DB']->query_value_null_ok('download_categories','id',array('parent_id'=>db_get_first_id(),$GLOBALS['SITE_DB']->translate_field_ref('category')=>'Releases'));
...
$release_category_id=$GLOBALS['SITE_DB']->query_value_null_ok('download_categories','id',array('parent_id'=>$releases_category_id,$GLOBALS['SITE_DB']->translate_field_ref('category')=>'Version '.strval(intval($version_dotted))));
...
$installatron_category_id=$GLOBALS['SITE_DB']->query_value_null_ok('download_categories','id',array('parent_id'=>$releases_category_id,$GLOBALS['SITE_DB']->translate_field_ref('category')=>'Installatron integration'));
...
$microsoft_category_id=$GLOBALS['SITE_DB']->query_value_null_ok('download_categories','id',array('parent_id'=>$releases_category_id,$GLOBALS['SITE_DB']->translate_field_ref('category')=>'Microsoft integration'));
...
foreach ($all_downloads_to_add as $i=>$d)
{
	...
	$download_id=$GLOBALS['SITE_DB']->query_value_null_ok('download_downloads','id',array('category_id'=>$category_id,$GLOBALS['SITE_DB']->translate_field_ref('name')=>$name));
...
{
	$last_version_str=$GLOBALS['SITE_DB']->query_value_null_ok('download_downloads','id',array($GLOBALS['SITE_DB']->translate_field_ref('comments')=>'This is the latest version.'),' AND d.id<>'.strval($all_downloads_to_add[0]['download_id']));
	if (!is_null($last_version_str))
	{
		$last_version_id=$GLOBALS['SITE_DB']->query_value_null_ok('download_downloads','id',array($GLOBALS['SITE_DB']->translate_field_ref('comments')=>'This is the latest version.'),' AND d.id<>'.strval($all_downloads_to_add[0]['download_id']));
...
$news_category=$GLOBALS['SITE_DB']->query_value_null_ok('news_categories','id',array($GLOBALS['SITE_DB']->translate_field_ref('nc_title')=>'New releases'));
...
$news_id=$GLOBALS['SITE_DB']->query_value_null_ok('news','id',array('news_category'=>$news_category,$GLOBALS['SITE_DB']->translate_field_ref('title')=>$news_title));
if (is_null($news_id))
{
