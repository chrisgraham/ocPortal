...
//			if ($name->evaluate()=='') @exit($myrow['the_page']);
	...
	function config_set()
	{
		...
		if ((post_param_integer('mod_rewrite',0)==1) && (substr(ocp_srv('SERVER_SOFTWARE'),0,6)=='Apache') && ((!file_exists(get_file_base().'/.htaccess')) || (strpos(strtolower(file_get_contents(get_file_base().'/.htaccess')),'rewriteengine on')===false)))
		{
