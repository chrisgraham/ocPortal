...
class Module_admin_config
{
	...
	function install($upgrade_from=NULL,$upgrade_from_hack=NULL)
	{
		...
		if (is_null($upgrade_from))
		{
			...
			//  Uploading
				add_config_option('FILE_TYPES','valid_types','line','return \'swf,sql,odg,odp,odt,ods,ps,pdf,doc,ppt,csv,xls,docx,pptx,xlsx,pub,txt,psd,tga,tif,gif,png,ico,bmp,jpg,jpeg,flv,avi,mov,3gp,mpg,mpeg,mp4,webm,asf,wmv,ram,ra,rm,qt,zip,tar,rar,gz,wav,mp3,ogg,ogv,torrent,php,css,tpl,ini,eml\';','SECURITY','UPLOADED_FILES'); // fla,html,htm,svg,xml kept out for security reasons
