	...
	function gui()
	{
		...
		foreach ($posts as $post)
		{
			...
			if (has_privilege(get_member(),'delete_content_history')) // Delete permanently
			{
				...
				$buttons->attach(do_template('BUTTON_SCREEN_ITEM',array('_GUID'=>'11c9f9ef4a646493544cb29778134960','IMMEDIATE'=>true,'URL'=>$url,'IMG'=>'menu___generic_admin__delete','TITLE_FULL'=>do_lang_tempcode('DELETE_HISTORY_POST'),'TITLE'=>do_lang_tempcode('DELETE_HISTORY_POST'))));
			}
			if ((has_privilege(get_member(),'restore_content_history')) && (!is_null($topic_exists)) && ($post['h_action']=='DELETE_POST')) // Restore
			{
				...
				$buttons->attach(do_template('BUTTON_SCREEN_ITEM',array('_GUID'=>'49623e00065f488bb27097bb722232dc','IMMEDIATE'=>true,'URL'=>$url,'IMG'=>'buttons__restore','TITLE_FULL'=>do_lang_tempcode('RESTORE_HISTORY_POST'),'TITLE'=>do_lang_tempcode('RESTORE_HISTORY_POST'))));
			}
			if ((has_privilege(get_member(),'restore_content_history')) && (!is_null($topic_exists)) && ($post['h_action']=='EDIT_POST')) // Restore
			{
				...
				$buttons->attach(do_template('BUTTON_SCREEN_ITEM',array('_GUID'=>'3f41d4d399676972c01ebb14f6ee56db','IMMEDIATE'=>true,'URL'=>$url,'IMG'=>'buttons__choose','TITLE_FULL'=>do_lang_tempcode('REVERT_HISTORY_POST'),'TITLE'=>do_lang_tempcode('REVERT_HISTORY_POST'))));
			}
