...
class Module_admin_ocf_merge_members
{
	...
	function actual()
	{
		...
		if ((is_null($to_id)) || (is_guest($to_id))) warn_exit(do_lang_tempcode('_USER_NO_EXIST',escape_html($to_username)));
		...
		if ((is_null($from_id)) || (is_guest($from_id))) warn_exit(do_lang_tempcode('_USER_NO_EXIST',escape_html($from_username)));
