...
class Module_admin_lookup
{
    ...
    {
        if ($be_deferential && get_forum_type() == 'ocf') {
            return null;
        }
    ...
    public function pre_run()
    {
        ...
        if ($param == '') {
            ...
            breadcrumb_set_parents(array(array('_SEARCH:admin_ocf_members:browse', do_lang_tempcode('MEMBERS')), array('_SELF:_SELF:browse', do_lang_tempcode('SEARCH'))));
