...
class Module_admin_redirects
{
	...
	//		if (ocp_enterprise())
			{
				$GLOBALS['SITE_DB']->query_insert('redirects',array('r_from_page'=>'hosting-submit','r_from_zone'=>'collaboration','r_to_page'=>'hosting-submit','r_to_zone'=>'site','r_is_transparent'=>1));
