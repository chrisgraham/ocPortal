{+START,IF,{$NOT,{$GET,in_panel}}}<div class="centered_inline_block"><div class="inline_block">{+END}{+START,BOX,{!SEARCH},,{$?,{$GET,in_panel},panel,light},,,}
	<form onsubmit="if (typeof this.elements['contents']=='undefined') { disable_button_just_clicked(this); return true; } if (check_fieldForBlankness(this.elements['contents'],event)) { return true; } return false;" action="{$URL_FOR_GET_FORM*,{URL}}" method="get">
		{$HIDDENS_FOR_GET_FORM,{URL}}

		<div>
			{+START,IF,{$EQ,{INPUT_FIELDS},1}}
				<div class="constrain_field">
					<input class="wide_field" onkeyup="update_ajax_search_list(this,event);" type="text" id="search_content" name="content" value="" />
				</div>
			{+END}
			...
			<div class="proceed_button">
				<input class="button_pageitem" type="submit" value="Search" onfocus="if (this.value=='Search') this.value='';" />
			</div>
        ...
        <div class="search_bottom"><a class="search_bottom" accesskey="4" href="{FULL_LINK*}" title="{!SEARCH_TITLE}">{!MORE_OPTIONS}</a></div>
	</form>
