		...
		<div>
			{+START,IF,{$EQ,{INPUT_FIELDS},1}}
				<div class="constrain_field">
					<input class="search-box" onkeyup="update_ajax_search_list(this,event);" type="text" id="search_content" name="content" value="Search" onfocus="if (this.value=='Search') this.value='';" />
				</div>
			{+END}
