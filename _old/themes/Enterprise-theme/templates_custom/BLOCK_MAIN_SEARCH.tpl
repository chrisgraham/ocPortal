<form onsubmit="if (typeof this.elements['contents']=='undefined') { disable_button_just_clicked(this); return true; } if (check_fieldForBlankness(this.elements['contents'],event)) { return true; } return false;" action="{$URL_FOR_GET_FORM*,{URL}}" method="get" class="inline">
	{$HIDDENS_FOR_GET_FORM,{URL}}

	<div class="inline">
		{+START,IF,{$EQ,{INPUT_FIELDS},1}}
			<input class="box" onkeyup="update_ajax_search_list(this,event);" type="text" id="search_content" name="content" value="" />
		{+END}
