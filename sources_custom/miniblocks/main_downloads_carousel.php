...
$all_rows=$GLOBALS['SITE_DB']->query('SELECT d.* FROM '.get_table_prefix().'download_downloads d WHERE '.$filter_where,20,NULL,false,false,array('name'=>'SHORT_TRANS','description'=>'LONG_TRANS__COMCODE'));
shuffle($all_rows);
