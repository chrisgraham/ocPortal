...
foreach ($gifts as $gift)
{
	...
	if (!is_null($username))
	{
		...
		echo '<tr><td>'.$avatar.'</td><td>Username: <a href="'.escape_html($link).'">'.escape_html($username).'</a><br /><br />Role points: '.number_format($points).'<br /><br />Rank: '.$rank.'</td><td style="font-size: 0.8em;">'.$signature->evaluate().'</td></tr>';
