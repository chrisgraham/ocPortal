...
//          array('Use ocPortal for your own clients','Are you a professional website developer? Try to start using ocPortal for your projects &ndash; it provides you [page="site:features"]lots of advantages[/page] to other software, it\'s free, and we want the community and install-base to grow!'),         Removed to save space
        ...
        'usability' => array(
            ...
            array(
                ...
                array('Developing unit tests', 'If you know some PHP you can help us test ocPortal en-masse. [url="{$BRAND_BASE_URL}/docs/ocportal_testing_framework.zip"]Write unit tests[/url] (the latest version of this framework is in our public git repository).'),
            ), null, true,
        ),
    ...
    'misc' => array(
        ...
        'featured' => array(
            'Featured content <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Featured content" href="http://shareddemo.myocp.com/site/index.php?page=featured_content"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'ecommerce' => array(
            'eCommerce and subscriptions <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of eCommerce" href="http://shareddemo.myocp.com/site/index.php?page=catalogues&amp;type=category&amp;id=home"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'web20' => array(
        'polls' => array(
            'Polls <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Polls" href="http://shareddemo.myocp.com/site/index.php?page=polls&amp;type=view&amp;id=what_type_of_books_do"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'content' => array(
        ...
        'calendar' => array(
            'Calendar <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Calendar" href="http://shareddemo.myocp.com/site/index.php?page=calendar"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'news' => array(
            'News and blogging <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of News" href="http://shareddemo.myocp.com/site/index.php?page=news&amp;type=select"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
                array('Member blogs', 'Allow members to have their own blogs <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of News" href="http://shareddemo.myocp.com/cms/index.php?page=cms_blogs"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Import from RSS feeds <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of News" href="http://shareddemo.myocp.com/cms/index.php?page=cms_news"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Easily syndicate to Facebook and Twitter'),
            ),
        ),
        'quizzes' => array(
            'Quizzes <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Galleries" href="http://shareddemo.myocp.com/site/index.php?page=quiz"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'pages' => array(
            'Page support <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Page support" href="http://shareddemo.myocp.com/site/index.php?page=comcode_page"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'architecture' => array(
        ...
        'integration' => array(
            ...
            array(
                ...
                array('LDAP support for corporate networks (<abbr title="ocPortal forum">OCF</abbr>) <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Help of LDAP usage" href="{$PAGE_LINK*,docs:tut_ldap}"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                null, // divider
                ...
                array('Minimodules and miniblocks', 'Programmers can port existing PHP code into ocPortal itself <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Framework documentation" href="{$PAGE_LINK*,docs:tut_framework}"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
    ...
    'design' => array(
        ...
        'rad' => array(
            ...
            array(
                array('Switch users', 'Masquerade as any user using your admin logging <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of SU" href="http://shareddemo.myocp.com/index.php?keep_su=test"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Change theme images inline with just a few clicks'),
                array('Easily find and edit the templates used to construct any screen <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Template Tree" href="http://shareddemo.myocp.com/index.php?special_page_type=tree"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'richmedia' => array(
            'Rich media and presentation support <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Comcode" href="http://shareddemo.myocp.com/index.php?page=rich"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'standards' => array(
        ...
        'itln' => array(
            'Localisation support <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Localisation" href="https://translations.launchpad.net/ocportal/+translations"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'seo' => array(
            'Search engine optimisation <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of SEO" href="http://shareddemo.myocp.com/index.php?page=sitemap"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'forums' => array(
        ...
        'ocfforum' => array(
            'Forum essentials',
            array(
                array('The usual stuff', 'Categories, forums, topics, posts, polls <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Forum" href="http://shareddemo.myocp.com/forum/index.php?page=topicview&amp;id=general_chat%2Fhere_is_a_topic_with_a"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Forum and Topic tracking', 'Get alerted by e-mail when new posts are made'),
                array('Password-protected forums <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Protected Forum" href="http://shareddemo.myocp.com/forum/index.php?page=forumview&amp;id=feedback"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Full moderator control', 'Determine who may moderate what forums'),
                null, // divider
                array('Quick reply'),
                array('Announcements <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Announcement" href="http://shareddemo.myocp.com/forum/index.php?page=topicview&amp;id=this_topic_acts_as_an"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'coolocfforum' => array(
            ...
            array(
                ...
                array('Inline personal posts', 'Whisper to members within a public topic <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Whispering" href="http://shareddemo.myocp.com/forum/index.php?page=topicview&amp;type=findpost&amp;id=6#post_6"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Records post edit/delete history <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Post History" href="http://shareddemo.myocp.com/adminzone/index.php?admin_ocf_history"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Post templates', 'Use your forum as a database for record gathering <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Post Templates" href="http://shareddemo.myocp.com/adminzone/index.php?admin_ocf_post_templates"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
...
// Columns
echo '<div class="feature_columns_a"><div class="feature_columns_b"><div class="feature_columns_c"><div class="feature_columns float_surrounder_hidden">' . "\n";
foreach (explode(',', $map['param']) as $i => $column) {
    ...
    foreach (explode('|', $column) as $subsection_code) {
        ...
        $subsection_title = template_to_tempcode($subsection_title);
            ...
            foreach ($subsection_items as $item) {
                if (is_null($item)) { // Divider
                    ...
                    if ((array_key_exists(3, $subsection)) && ($subsection[3])) {
                        ...
                        if (array_key_exists(1, $item)) {
                            $item[1] = template_to_tempcode($item[1]);
                            $item[1] = $item[1]->evaluate();
                        }
                    }
