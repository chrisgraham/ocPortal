...
if (isset($map['param']))
{
	...
	{
		$group_id=$GLOBALS['FORUM_DB']->query_select_value_if_there('f_groups g JOIN '.$GLOBALS['FORUM_DB']->get_table_prefix().'translate t ON t.id=g.g_name','g.id',array('text_original'=>$map['param']));
		if (is_null($group_id))
		{
