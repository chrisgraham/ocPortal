	...
	'forums'=>array(
		'ocfmembers'=>array(
			...
			array(
				...
				NULL, // divider
				array('Over 40 bundled avatars','Member\'s may also upload or link to their own <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Avatars" href="http://shareddemo.myocp.com/personalzone/index.php?page=edit_avatar&amp;type=misc"><img class="inline_image_3" alt="" src="{$IMG*,help}" /></a>'),
				array('Member signatures, photos, and personal titles <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Personal Zone" href="http://shareddemo.myocp.com/personalzone/index.php?page=myhome&amp;type=misc"><img class="inline_image_3" alt="" src="{$IMG*,help}" /></a>'),
		...
		'coolocfmembers'=>array(
			...
			array(
				...
				array('Members may set privacy settings for individual fields <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Privacy Settings" href="http://shareddemo.myocp.com/personalzone/index.php?page=privacy"><img class="inline_image_3" alt="" src="{$IMG*,help}" /></a>'),
