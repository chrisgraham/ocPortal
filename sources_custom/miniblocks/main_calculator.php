...
echo '
	...
	<p class="proceed_button">
		<input onclick="if (check_form(this.form)) window.fauxmodal_alert(\'' . $message . '\'.replace(\'xxx\',calculate_sum_' . $uniqid . '(this.form.elements))); return false;" classs="buttons__calculate button_screen_item" type="submit" value="Calculate" />
	</p>
</form>
';
