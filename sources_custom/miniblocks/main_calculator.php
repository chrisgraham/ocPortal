...
echo '
	...
	<p class="proceed_button">
		<input onclick="if (checkForm(this.form)) window.alert(\''.$message.'\'.replace(\'xxx\',calculate_sum_'.$uniqid.'(this.form.elements))); return false;" type="submit" value="Calculate" />
	</p>
</form>
';
