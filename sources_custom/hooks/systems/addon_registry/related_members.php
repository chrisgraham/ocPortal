...
The particular CPF used is defined by the [tt]RELATED_CPF[/tt] language string (the default is "Member grouping").';
    }
    ...
    {
        return 'themes/default/images/icons/48x48/buttons/more.png';
    }
