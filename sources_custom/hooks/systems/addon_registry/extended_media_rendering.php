...
class Hook_addon_registry_extended_media_rendering
{
    ...
    {
        return 'A collection of additional media renderers. Currently, this only includes CNN video -- however, further renderers that don\'t belong in the ocPortal core will be added to this addon as they are developed.';
    }
