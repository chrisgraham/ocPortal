...
class Hook_addon_registry_db_schema
{
	/**
	...
	{
		return 'Build structure (schema) documentation for the ocPortal database.';
	}
	...
	{
		return array(
			'sources_custom/hooks/systems/addon_registry/db_schema.php',
			...
			'sources_custom/hooks/systems/do_next_menus/db_schema.php',
