...
function make_installers($skip_file_grab = false)
{
    ...
    */
    ...
    if ($make_mszip) {
        @unlink($mszip);
        if (file_exists($builds_path . '/builds/build/ocportal/')) {
            deldir_contents($builds_path . '/builds/build/ocportal/');
        }
    ...
    while (($file = readdir($dh)) !== false) {
        ...
        if ($is_dir) {
            ...
            if (($pretend_dir . $file) == '_config.php') {
                ...
                $MAKE_INSTALLERS__FILE_ARRAY[$pretend_dir . $file] = '';
            } elseif ($pretend_dir . $file == 'data_custom/aggregate_types.xml') {
                $MAKE_INSTALLERS__FILE_ARRAY[$pretend_dir . $file] = '';
            } elseif ($pretend_dir . $file == 'ocp_sitemap.xml') {
                $MAKE_INSTALLERS__FILE_ARRAY[$pretend_dir . $file] = '';
            } elseif ($pretend_dir . $file == 'ocp_news_sitemap.xml') {
                $MAKE_INSTALLERS__FILE_ARRAY[$pretend_dir . $file] = '';
