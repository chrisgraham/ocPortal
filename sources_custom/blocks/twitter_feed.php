...
class Block_twitter_feed
{
	...
	function run($map)
	{
		...
		if ( (get_option('twitterfeed_use_twitter_support_config',true)=='1') && ($api_key=='' || $api_secret=='' || $token=='' || $token_secret=='') ) {
	 ...
	 */
	function _convert_name_callback($matches)
	{
	 ...
	 * @return string Substituted text
	 */
	function _convert_hashtag_callback($matches)
	{
	 ...
	 * @return string Substituted text
	 */
	function _convert_url_callback($matches)
	{
	 ...
	 * @return string Substituted text
	 */
	function _convert_website_callback($matches)
	{
