...
cacls data_custom\spelling\output.log /e /g %user%:F
cacls data_custom\spelling\write.log /e /g %user%:F
...
icacls data_custom\spelling\output.log /grant %user%:(M)
icacls data_custom\spelling\write.log /grant %user%:(M)
