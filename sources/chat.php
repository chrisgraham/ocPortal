		...
		if (!member_blocked(get_member(),$member_id))
		{
			...
			if (!is_guest($member_id))
			{
				if (get_forum_type()=='ocf')
				{
					...
					$usernames->attach(do_template('OCF_USER_MEMBER',array('PROFILE_URL'=>$GLOBALS['FORUM_DRIVER']->member_profile_link($member_id,true,true),'USERNAME'=>$username,'COLOUR'=>$colour)));
				} else
				{
