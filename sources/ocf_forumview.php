...
function ocf_render_forumview($id,$current_filter_cat,$max,$start,$root,$of_member_id)
{
	...
	if ($type=='pt')
	{
		...
		$tree=hyperlink(build_url(array('page'=>'_SELF','id'=>($root==db_get_first_id())?NULL:$root),'_SELF'),escape_html($root_forum_name),false,false,do_lang_tempcode('GO_BACKWARDS_TO',escape_html($root_forum_name)),NULL,NULL,'up');
		$tree->attach(' &gt; ');
