...
function get_privacy_form_fields($content_type,$content_id=NULL,$show_header=true,$prefix='')
{
	...
	{
		$test=is_null($content_type)?NULL:$GLOBALS['SITE_DB']->query_value_null_ok('content_privacy','AVG(guest_view)',array('content_type'=>$content_type));
		if ($test===NULL)
		{
			$view_by_guests=true;
		} else
		...
		$test=is_null($content_type)?NULL:$GLOBALS['SITE_DB']->query_value_null_ok('content_privacy','AVG(member_view)',array('content_type'=>$content_type));
		if ($test===NULL)
		{
			$view_by_members=true;
		} else
		...
		$test=is_null($content_type)?NULL:$GLOBALS['SITE_DB']->query_value_null_ok('content_privacy','AVG(friend_view)',array('content_type'=>$content_type));
		if ($test===NULL)
		{
			$view_by_friends=true;
		} else
