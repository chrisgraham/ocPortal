 ...
 * @param  boolean                      $trigger_error Whether to throw an ocPortal error, on error. Should not be 'true' for automatic spammer reports, as the spammer should not see the submission process in action!
 */
