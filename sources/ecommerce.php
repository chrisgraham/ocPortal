...
function handle_confirmed_transaction($purchase_id,$item_name,$payment_status,$reason_code,$pending_reason,$memo,$mc_gross,$mc_currency,$txn_id,$parent_txn_id,$source='',$period='')
{
	...
	elseif (($payment_status=='Pending') && ($item_name==do_lang('shopping:CART_ORDER',$purchase_id))) // Cart orders have special support for tracking the order status
	{
 ...
 * @set    y m d w
 * @param  GROUP			The usergroup that purchasing gains membership to
