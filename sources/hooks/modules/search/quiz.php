...
class Hook_search_quiz
{
	...
	function run($content,$only_search_meta,$direction,$max,$start,$only_titles,$content_where,$author,$author_id,$cutoff,$sort,$limit_to,$boolean_operator,$where_clause,$search_under,$boolean_search)
	{
		...
		$rows=get_search_rows('quiz','id',$content,$boolean_search,$boolean_operator,$only_search_meta,$direction,$max,$start,$only_titles,'quizzes r',array(''=>'','r.q_start_text'=>'LONG_TRANS__COMCODE'),$where_clause,$content_where,$remapped_orderer,'r.*');
