...
class Hook_search_calendar
{
	...
	function run($content,$only_search_meta,$direction,$max,$start,$only_titles,$content_where,$author,$author_id,$cutoff,$sort,$limit_to,$boolean_operator,$where_clause,$search_under,$boolean_search)
	{
		...
		$rows=get_search_rows('event','id',$content,$boolean_search,$boolean_operator,$only_search_meta,$direction,$max,$start,$only_titles,'calendar_events r',array('r.e_title','r.e_content'),$where_clause,$content_where,$remapped_orderer,'r.*');
