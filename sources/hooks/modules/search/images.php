...
class Hook_search_images
{
	...
	function run($content,$only_search_meta,$direction,$max,$start,$only_titles,$content_where,$author,$author_id,$cutoff,$sort,$limit_to,$boolean_operator,$where_clause,$search_under,$boolean_search)
	{
		...
		{
			case 'rating':
				$remapped_orderer='_rating:images:id';
				break;
		...
		$rows=get_search_rows('image','id',$content,$boolean_search,$boolean_operator,$only_search_meta,$direction,$max,$start,$only_titles,'images r',array(''=>'','r.comments'=>'LONG_TRANS__COMCODE','r.title'=>'SHORT_TRANS'),$where_clause,$content_where,$remapped_orderer,'r.*',array(),'galleries','cat',true);
