...
class Hook_whatsnew_wiki
{
    ...
    public function run($cutoff_time, $lang, $filter)
    {
        ...
        foreach ($rows as $row) {
            ...
            $member_id = null;
            $new->attach(do_template('w', array('_GUID' => '29571e3829c6723b2ca946436a6cadb2', 'MEMBER_ID' => $member_id, 'URL' => $url, 'NAME' => $name, 'DESCRIPTION' => $description, 'CONTENT_TYPE' => 'wiki_page', 'CONTENT_ID' => strval($id)), null, false, null, '.txt', 'text'));
        }
