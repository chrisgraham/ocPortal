...
class Hook_wowbb
{
	...
	function import_calendar($db,$table_prefix,$file_base)
	{
		...
		foreach ($rows as $row)
		{
			...
			$id_new=add_calendar_event(db_get_first_id()+1,$recurrence,intval(floor($recurrences)),0,$row['event_title'],$row['event_note'],3,$row['event_public'],$start_year,$start_month,$start_day,'day_of_month',$start_hour,$start_minute,$end_year,$end_month,$end_day,'day_of_month',$end_hour,$end_minute,NULL,1,NULL,1,1,1,1,'',$submitter,0,strtotime($row['event_start']));
