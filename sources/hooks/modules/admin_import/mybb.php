...
class Hook_mybb
{
	...
	function import_calendar($db,$table_prefix,$file_base)
	{
		...
		foreach ($rows as $row)
		{
			...
			ocf_over_msn();
			$id_new=add_calendar_event(db_get_first_id()+1,$recurrence,$recurrences,0,$row['name'],$row['description'],3,$row['visible'],$start_year,$start_month,$start_day,'day_of_month',$start_hour,$start_minute,$end_year,$end_month,$end_day,'day_of_month',$end_hour,$end_minute,NULL,1,NULL,1,1,1,1,'',$submitter,0,$row['dateline']);
			ocf_over_local();
