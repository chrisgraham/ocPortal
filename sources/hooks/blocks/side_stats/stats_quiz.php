...
class Hook_stats_quiz
{
	...
	function run()
	{
		...
		if (get_option('quiz_show_stats_count_total_open',true)=='1') $bits->attach(do_template('BLOCK_SIDE_STATS_SUBLINE',array('_GUID'=>'736e5008b15c984768234dde7586adf7','KEY'=>do_lang_tempcode('QUIZZES'),'VALUE'=>integer_format($GLOBALS['SITE_DB']->query_select_value('quizzes','COUNT(*)')))));
