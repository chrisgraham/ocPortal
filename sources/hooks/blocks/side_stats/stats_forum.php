...
class Hook_stats_forum
{
	...
	function run()
	{
		if (get_forum_type()!='none')
		{
			...
			{
				if (get_option('forum_show_stats_count_members_new_today',true)=='1') $bits->attach(do_template('BLOCK_SIDE_STATS_SUBLINE',array('_GUID'=>'fd2e149f6921836e3c2ea1039644e2e7','KEY'=>do_lang_tempcode('MEMBERS_NEW_TODAY'),'VALUE'=>integer_format($GLOBALS['FORUM_DB']->query_value_if_there('SELECT COUNT(*) FROM '.$GLOBALS['FORUM_DB']->get_table_prefix().'f_members WHERE m_join_time>'.strval(time()-60*60*24))))));
				if (get_option('forum_show_stats_count_members_new_this_week',true)=='1') $bits->attach(do_template('BLOCK_SIDE_STATS_SUBLINE',array('_GUID'=>'10128b288dec4a578517de75cc9e404d','KEY'=>do_lang_tempcode('MEMBERS_NEW_THIS_WEEK'),'VALUE'=>integer_format($GLOBALS['FORUM_DB']->query_value_if_there('SELECT COUNT(*) FROM '.$GLOBALS['FORUM_DB']->get_table_prefix().'f_members WHERE m_join_time>'.strval(time()-60*60*24*7))))));
				if (get_option('forum_show_stats_count_members_new_this_month',true)=='1') $bits->attach(do_template('BLOCK_SIDE_STATS_SUBLINE',array('_GUID'=>'b2dbcdec813d5a5edbb416bf087b4a97','KEY'=>do_lang_tempcode('MEMBERS_NEW_THIS_MONTH'),'VALUE'=>integer_format($GLOBALS['FORUM_DB']->query_value_if_there('SELECT COUNT(*) FROM '.$GLOBALS['FORUM_DB']->get_table_prefix().'f_members WHERE m_join_time>'.strval(time()-60*60*24*31))))));
				if (get_option('forum_show_stats_count_members_active_today',true)=='1') $bits->attach(do_template('BLOCK_SIDE_STATS_SUBLINE',array('_GUID'=>'cc9760b2ed9e985e96b53c91c511e84e','KEY'=>do_lang_tempcode('MEMBERS_ACTIVE_TODAY'),'VALUE'=>integer_format($GLOBALS['FORUM_DB']->query_value_if_there('SELECT COUNT(*) FROM '.$GLOBALS['FORUM_DB']->get_table_prefix().'f_members WHERE m_last_visit_time>'.strval(time()-60*60*24))))));
				if (get_option('forum_show_stats_count_members_active_this_week',true)=='1') $bits->attach(do_template('BLOCK_SIDE_STATS_SUBLINE',array('_GUID'=>'dc9760b2ed9e985e96b53c91c511e84e','KEY'=>do_lang_tempcode('MEMBERS_ACTIVE_THIS_WEEK'),'VALUE'=>integer_format($GLOBALS['FORUM_DB']->query_value_if_there('SELECT COUNT(*) FROM '.$GLOBALS['FORUM_DB']->get_table_prefix().'f_members WHERE m_last_visit_time>'.strval(time()-60*60*24*7))))));
				if (get_option('forum_show_stats_count_members_active_this_month',true)=='1') $bits->attach(do_template('BLOCK_SIDE_STATS_SUBLINE',array('_GUID'=>'ec9760b2ed9e985e96b53c91c511e84e','KEY'=>do_lang_tempcode('MEMBERS_ACTIVE_THIS_MONTH'),'VALUE'=>integer_format($GLOBALS['FORUM_DB']->query_value_if_there('SELECT COUNT(*) FROM '.$GLOBALS['FORUM_DB']->get_table_prefix().'f_members WHERE m_last_visit_time>'.strval(time()-60*60*24*31))))));
			}
			if (!has_no_forum())
			{
