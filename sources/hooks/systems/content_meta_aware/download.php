...
class Hook_content_meta_aware_download
{
	...
	function info($zone=NULL)
	{
		return array(
			...
			'add_url'=>(has_submit_permission('mid',get_member(),get_ip_address(),'cms_downloads'))?build_url(array('page'=>'cms_downloads','type'=>'ad'),get_module_zone('cms_downloads')):new ocp_tempcode(),
