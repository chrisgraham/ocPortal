...
class Hook_resource_meta_aware_usergroup_subscription
{
	...
	function info($zone=NULL)
	{
		return array(
			...
			'edit_pagelink_pattern'=>'_SEARCH:admin_ecommerce:_ed:_WILD',
			'view_category_pagelink_pattern'=>NULL,
			'add_url'=>(has_actual_page_access(get_member(),'admin_ecommerce'))?(get_module_zone('admin_ecommerce').':admin_ecommerce:ad'):NULL,
			'archive_url'=>NULL,
