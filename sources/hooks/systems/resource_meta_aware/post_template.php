...
class Hook_resource_meta_aware_post_template
{
    ...
    public function info($zone = null)
    {
        return array(
            ...
            'edit_page_link_pattern' => '_SEARCH:admin_ocf_post_templates:_ed:_WILD',
            'view_category_page_link_pattern' => null,
            'add_url' => (function_exists('get_member') && has_actual_page_access(get_member(), 'admin_ocf_post_templates')) ? (get_module_zone('admin_ocf_post_templates') . ':admin_ocf_post_templates:ad') : null,
            'archive_url' => null,
