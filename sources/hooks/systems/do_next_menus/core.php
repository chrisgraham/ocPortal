...
class Hook_do_next_menus_core
{
	...
	function run()
	{
		return array(
			...
			(get_value('mail_queue')!=='1')?NULL:array('usage','newsletters',array('admin_emaillog',array('type'=>'misc'),get_module_zone('admin_emaillog')),do_lang_tempcode('EMAIL_QUEUE'),('DOC_EMAIL_QUEUE')),
