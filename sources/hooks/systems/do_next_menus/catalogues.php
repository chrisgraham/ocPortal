...
class Hook_do_next_menus_catalogues
{
	...
	function run($exhaustive=false)
	{
		...
		$ret[]=array('rich_content','menu/rich_content/catalogues/catalogues',array('catalogues',array(),get_module_zone('catalogues')),do_lang_tempcode('catalogues:CATALOGUES'));
