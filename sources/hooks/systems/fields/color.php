...
class Hook_fields_color
{
	...
	function get_field_value_row_bits($field,$required=NULL,$default=NULL)
	{
		if ($required!==NULL)
		{
			if (($required) && ($default=='')) $default='666666';
		}
	...
	function get_field_inputter($_cf_name,$_cf_description,$field,$actual_value,$new)
	{
		...
		return form_input_colour($_cf_name,$_cf_description,'field_'.strval($field['id']),$actual_value,$field['cf_required']==1);
	}
	...
	function inputted_to_field_value($editing,$field,$upload_dir='uploads/catalogues',$old_value=NULL)
	{
		...
		return preg_replace('#^\##','',post_param($tmp_name,$editing?STRING_MAGIC_NULL:''));
	}
}
