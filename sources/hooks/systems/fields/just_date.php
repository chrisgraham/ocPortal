...
class Hook_fields_just_date
{
	...
	function get_field_inputter($_cf_name,$_cf_description,$field,$actual_value,$new)
	{
		...
		*/
		$min_year=NULL;
		$years_to_show=NULL;
		return form_input_date($_cf_name,$_cf_description,'field_'.strval($field['id']),$field['cf_required']==0,($field['cf_required']==0) && ($actual_value==''),false,$time,$years_to_show,$min_year,null,true,null,false);
	}
