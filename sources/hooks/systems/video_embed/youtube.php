...
class Hook_video_embed_youtube
{
	...
	function add_custom_comcode_field()
	{
		$GLOBALS['SITE_DB']->query_insert('custom_comcode',array(
			...
			'tag_replace'=>'{$SET,VIDEO,{$PREG_REPLACE,(https?://.*\?v=)?(https?://youtu.be/)?([\w\-]+)(.*)?,$\{3\},{$STRIP_TAGS,{content}}}}<iframe width="480" height="385" src="https://www.youtube.com/embed/{$GET*,VIDEO}" frameborder="0" allowfullscreen></iframe>',
