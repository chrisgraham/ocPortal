    ...
    public function run($member_id = null, $extensive_docs = false)
    {
        ...
        return array(
            ...
            (get_forum_type() == 'ocf' || !addon_installed('welcome_emails')) ?/*Is on members menu*/
                null : array('setup', 'menu/adminzone/setup/welcome_emails', array('admin_ocf_welcome_emails', array('type' => 'misc'), get_module_zone('admin_ocf_welcome_emails')), do_lang_tempcode('ocf_welcome_emails:WELCOME_EMAILS'), 'ocf_welcome_emails:DOC_WELCOME_EMAILS'),
