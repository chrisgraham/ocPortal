...
class Hook_Notification_ticket_reply extends Hook_Notification
{
	/**
	...
	{
		$list=array();
		$list['ticket_reply']=array(do_lang('MESSAGES'),do_lang('NOTIFICATION_TYPE_ticket_reply'));
		return $list;
	}
	...
	function list_members_who_have_enabled($notification_code,$category=NULL,$to_member_ids=NULL,$start=0,$max=300)
	{
		...
		$members=$this->_all_members_who_have_enabled_with_page_access($members,'tickets',$notification_code,$category,$to_member_ids,$start,$max);
