...
class Hook_Notification_paid_subscription_started extends Hook_Notification
{
	/**
	...
	{
		$list=array();
		$list['paid_subscription_started']=array(do_lang('ecommerce:ECOMMERCE'),do_lang('ecommerce:NOTIFICATION_TYPE_paid_subscription_started'));
		return $list;
	}
