...
class Hook_Notification_ticket_assigned_staff extends Hook_Notification
{
    ...
    public function create_category_tree($notification_code, $id)
    {
        ...
        foreach ($tickets as $ticket) {
            $details = get_ticket_details($ticket['l_code_category']);
            if (is_null($details)) {
                continue;
            }
    ...
    {
        $list = array();
        $list['ticket_assigned_staff'] = array(do_lang('notifications:MESSAGES'), do_lang('tickets:NOTIFICATION_TYPE_ticket_assigned_staff'));
        return $list;
    }
