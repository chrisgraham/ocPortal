...
class Hook_Notification_poll_chosen extends Hook_Notification
{
	/**
	...
	{
		$list=array();
		$list['poll_chosen']=array(do_lang('menus:CONTENT'),do_lang('polls:NOTIFICATION_TYPE_poll_chosen'));
		return $list;
	}
	...
	function list_members_who_have_enabled($notification_code,$category=NULL,$to_member_ids=NULL,$start=0,$max=300)
	{
		...
		$members=$this->_all_members_who_have_enabled_with_page_access($members,'polls',$notification_code,$category,$to_member_ids,$start,$max);
