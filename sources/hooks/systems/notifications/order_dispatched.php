...
class Hook_Notification_order_dispatched extends Hook_Notification
{
	/**
	...
	{
		$list=array();
		$list['order_dispatched']=array(do_lang('ecommerce:ECOMMERCE'),do_lang('NOTIFICATION_TYPE_order_dispatched'));
		return $list;
	}
	...
	function list_members_who_have_enabled($notification_code,$category=NULL,$to_member_ids=NULL,$start=0,$max=300)
	{
		...
		$members=$this->_all_members_who_have_enabled_with_page_access($members,'shopping',$notification_code,$category,$to_member_ids,$start,$max);
