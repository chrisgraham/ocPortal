...
class Hook_choose_gallery
{
    ...
    public function run($id, $options, $default = null)
    {
        ...
        $tree = get_gallery_tree(is_null($id) ? 'root' : $stripped_id, '', null, false, $filter, false, false, $purity, $compound_list, is_null($id) ? 0 : 1, $member_id, $addable_filter, $editable_filter);
