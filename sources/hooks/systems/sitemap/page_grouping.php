...
Note that the page group hook should work from the configured menus primarily, then put in anything unlinked at the top level (and remove anything that does not belong)
