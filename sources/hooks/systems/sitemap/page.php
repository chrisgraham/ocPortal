...
class Hook_sitemap_?
{
	...
	{
		// TODO (including entry-points; the default entry-point being absorbed as the parent to the others)
		// TODO (We need some sense for how the root category may overwrite the main page entry-point)
