...
class Hook_occle_fs_groups extends resource_fs_base
{
	 ...
	 */
	function __folder_read_in_properties($path,$properties)
	{
	...
	function _file_load($filename,$path)
	{
		...
		$ret=array(
			...
			'primary_group'=>$row['m_primary_group'],
	...
	function file_edit($filename,$path,$properties)
	{
		...
		ocf_edit_member(intval($resource_id),$email_address,$preview_posts,$dob_day,$dob_month,$dob_year,$timezone,$primary_group,$custom_fields,$theme,$reveal_age,$views_signatures,$auto_monitor_contrib_content,$language,$allow_emails,$allow_emails_from_staff,$validated,$label,$password,$zone_wide,$highlighted_name,$pt_allow,$pt_rules_text,$on_probation_until,$join_time,$avatar_url,$signature,$is_perm_banned,$photo_url,$photo_thumb_url,$salt,$password_compatibility_scheme,true);
