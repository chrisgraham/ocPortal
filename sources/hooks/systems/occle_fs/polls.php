...
class Hook_occle_fs_polls extends content_fs_base
{
	...
	function _file_load($filename,$path)
	{
		...
		$rows=$GLOBALS['SITE_DB']->query_select('poll',array('*'),array('id'=>intval($content_id)),'',1);
	...
	function file_edit($filename,$path,$properties)
	{
		...
		edit_poll(intval($content_id),$label,$a1,$a2,$a3,$a4,$a5,$a6,$a7,$a8,$a9,$a10,$num_options,$allow_rating,$allow_comments,$allow_trackbacks,$notes,$edit_time,$add_time,$views,$submitter,true);
