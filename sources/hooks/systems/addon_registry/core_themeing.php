...
class Hook_addon_registry_core_themeing
{
	...
	*/
	function tpl_preview__administrative__theme_manage_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('THEME_MANAGE_SCREEN',array(
					'TITLE'=>lorem_title(),
					'THEMES'=>$themes,
	...
	*/
	function tpl_preview__administrative__theme_edit_css_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('THEME_EDIT_CSS_SCREEN',array(
					'PING_URL'=>placeholder_url(),
					'WARNING_DETAILS'=>'',
					'REVISION_HISTORY'=>lorem_phrase(),
					'SWITCH_ICON'=>placeholder_img_code(''),
	...
	*/
	function tpl_preview__administrative__template_manage_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('TEMPLATE_MANAGE_SCREEN',array(
					'THEME'=>lorem_phrase(),
					'PING_URL'=>placeholder_url(),
					'WARNING_DETAILS'=>'',
					'TITLE'=>lorem_title(),
	...
	*/
	function tpl_preview__administrative__template_edit_screen()
	{
		...
		{
			$guids[]=array('FILENAME'=>$_guid,'LINE'=>placeholder_number(),'THIS_GUID'=>$_guid);
		}

		$parameters	=	new ocp_tempcode();
		foreach (placeholder_array() as $value)
		{
			$parameters->attach(form_input_list_entry($value,false,$value));
		}

		$parameters = do_lorem_template('TEMPLATE_EDIT_SCREEN_DROPDOWN',array('ID'=>placeholder_id(),'PARAMETERS'=>$parameters,'NAME'=>lorem_word(),'LANG'=>lorem_phrase()));

		$template_editors	=	new ocp_tempcode();

		$template_editors->attach(
				do_lorem_template('TEMPLATE_EDIT_SCREEN_EDITOR',array(
					'CODENAME'=>lorem_word(),
					'I'=>lorem_word(),
					'DISPLAY'=>'block',
					'GUIDS'=>$guids,
					'GUID'=>placeholder_id(),
					'ARITHMETICAL_SYMBOLS'=>lorem_phrase(),
					'FORMATTING_SYMBOLS'=>placeholder_form(),
					'LOGICAL_SYMBOLS'=>lorem_phrase(),
					'ABSTRACTION_SYMBOLS'=>lorem_phrase(),
					'PARAMETERS'=>$parameters,
					'DIRECTIVES'=>lorem_phrase(),
					'PROGRAMMATIC_SYMBOLS'=>lorem_phrase(),
					'SYMBOLS'=>lorem_phrase(),
					'FILE'=>lorem_phrase(),
					'FILE_SAVE_TARGET'=>lorem_phrase(),
					'OLD_CONTENTS'=>lorem_phrase(),
		...
		return array(
			lorem_globalise(
				do_lorem_template('TEMPLATE_EDIT_SCREEN',array(
	...
	*/
	function tpl_preview__administrative__theme_image_manage_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('THEME_IMAGE_MANAGE_SCREEN',array(
	...
	*/
	function tpl_preview__administrative__theme_image_preview()
	{
		return array(
			lorem_globalise(
				do_lorem_template('THEME_IMAGE_PREVIEW',array(
	...
	*/
	function tpl_preview__administrative__template_tree_screen()
	{
		...
		foreach (placeholder_array() as $value)
		{
			$middle->attach(do_lorem_template('TEMPLATE_TREE_ITEM_WRAP',array('CONTENT'=>lorem_phrase())));
		}

		$tree->attach(do_lorem_template('TEMPLATE_TREE_NODE',array('ITEMS'=>$middle)));

		return array(
			lorem_globalise(
				do_lorem_template('TEMPLATE_TREE',array(
					'HIDDEN'=>'',
					'EDIT_URL'=>placeholder_url(),
					'TREE'=>$tree
						)
	...
	*/
	function tpl_preview__administrative__template_list_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('TEMPLATE_LIST_SCREEN',array(
					'TITLE'=>lorem_title(),
					'TEMPLATES'=>$ftemp,
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__administrative__template_edit_link_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('TEMPLATE_EDIT_LINK',array(
