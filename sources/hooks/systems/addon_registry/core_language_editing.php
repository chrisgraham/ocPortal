...
class Hook_addon_registry_core_language_editing
{
	...
	*/
	...
	function tpl_preview__administrative__translate_language_criticise_screen()
	{
		...
		{
			$crit=do_lorem_template('TRANSLATE_LANGUAGE_CRITICISM',array('CRITICISM'=>lorem_sentence()));
			$file->attach($crit);
		}
		$file_result=do_lorem_template('TRANSLATE_LANGUAGE_CRITICISE_FILE',array('COMPLAINTS'=>$file,'FILENAME'=>do_lang_tempcode('NA_EM')));

		$files.=$file_result->evaluate();

		return array(
			lorem_globalise(
				do_lorem_template('TRANSLATE_LANGUAGE_CRITICISE_SCREEN',array(
					'TITLE'=>lorem_title(),
					'FILES'=>$files,
						)
			),NULL,'',true),
	...
	function tpl_preview__administrative__translate_screen_content_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('TRANSLATE_SCREEN_CONTENT_SCREEN',array(
	...
	function tpl_preview__administrative__translate_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('TRANSLATE_SCREEN',array(
					'PAGE'=>lorem_phrase(),
					'INTERTRANS'=>lorem_phrase(),
					'LANG'=>fallback_lang(),
					'LINES'=>$lines,
