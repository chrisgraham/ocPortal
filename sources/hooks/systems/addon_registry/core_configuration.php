...
class Hook_addon_registry_core_configuration
{
	...
	function get_file_list()
	{
		return array(
			...
			'sources/hooks/systems/config/ocp_show_avatar.php',
			'sources/hooks/systems/config/ocp_show_conceded_mode_link.php',
			'sources/hooks/systems/config/ocp_show_personal_adminzone_link.php',
			'sources/hooks/systems/config/ocp_show_personal_last_visit.php',
			'sources/hooks/systems/config/ocp_show_personal_usergroup.php',
			'sources/hooks/systems/config/ocp_show_staff_page_actions.php',
			'sources/hooks/systems/config/ocp_show_su.php',
