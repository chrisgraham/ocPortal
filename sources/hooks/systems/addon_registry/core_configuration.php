...
class Hook_addon_registry_core_configuration
{
	...
	{
		return array(
			'sources/hooks/systems/config_default/max_moniker_length.php',
			'sources/hooks/systems/config_default/enable_seo_fields.php',
			'sources/hooks/systems/config_default/enable_staff_notes.php',
			'sources/hooks/systems/config_default/filetype_icons.php',
			'sources/hooks/systems/config_default/force_local_temp_dir.php',
			'sources/hooks/systems/config_default/general_safety_listing_limit.php',
			'sources/hooks/systems/config_default/hack_ban_threshold.php',
			'sources/hooks/systems/config_default/honeypot_phrase.php',
			'sources/hooks/systems/config_default/honeypot_url.php',
			'sources/hooks/systems/config_default/implied_spammer_confidence.php',
			'sources/hooks/systems/config_default/edit_under.php',
			'sources/hooks/systems/config_default/enable_animations.php',
			'sources/hooks/systems/config_default/breadcrumb_crop_length.php',
			'sources/hooks/systems/config_default/brute_force_instant_ban.php',
			'sources/hooks/systems/config_default/brute_force_login_minutes.php',
			'sources/hooks/systems/config_default/brute_force_threshold.php',
			'sources/hooks/systems/config_default/call_home.php',
			'sources/hooks/systems/config_default/cleanup_files.php',
			'sources/hooks/systems/config_default/jpeg_quality.php',
			'sources/hooks/systems/config_default/mail_queue.php',
			'sources/hooks/systems/config_default/mail_queue_debug.php',
			'sources/hooks/systems/config_default/modal_user.php',
			'sources/hooks/systems/config_default/password_cookies.php',
			'sources/hooks/systems/config_default/proxy.php',
			'sources/hooks/systems/config_default/proxy_password.php',
			'sources/hooks/systems/config_default/proxy_port.php',
			'sources/hooks/systems/config_default/proxy_user.php',
			'sources/hooks/systems/config_default/session_prudence.php',
			'sources/hooks/systems/config_default/tornevall_api_password.php',
			'sources/hooks/systems/config_default/tornevall_api_username.php',
			'sources/hooks/systems/config_default/use_true_from.php',
			'sources/hooks/systems/config_default/vote_member_ip_restrict.php',
			'sources/hooks/systems/config_default/spam_approval_threshold.php',
			'sources/hooks/systems/config_default/spam_ban_threshold.php',
			'sources/hooks/systems/config_default/spam_blackhole_detection.php',
			'sources/hooks/systems/config_default/spam_block_lists.php',
			'sources/hooks/systems/config_default/spam_block_threshold.php',
			'sources/hooks/systems/config_default/spam_cache_time.php',
			'sources/hooks/systems/config_default/spam_check_exclusions.php',
			'sources/hooks/systems/config_default/spam_check_level.php',
			'sources/hooks/systems/config_default/spam_check_usernames.php',
			'sources/hooks/systems/config_default/spam_stale_threshold.php',
			'sources/hooks/systems/config_default/stats_when_closed.php',
			'sources/hooks/systems/config_default/stopforumspam_api_key.php',
			'sources/hooks/systems/config_default/cdn.php',
			...
			'sources/hooks/systems/config_default/url_scheme.php',
