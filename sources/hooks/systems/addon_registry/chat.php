...
class Hook_addon_registry_chat
{
    ...
    public function get_file_list()
    {
        return array(
            ...
            'sources/hooks/systems/occle_fs/chat.php',
            ...
            'sources/hooks/systems/occle_commands/send_chatmessage.php',
    ...
    public function tpl_previews()
    {
        return array(
            ...
            'templates/BLOCK_MAIN_FRIENDS_LIST.tpl' => 'ocf_member_profile_friends',
            'templates/OCF_MEMBER_PROFILE_FRIENDS.tpl' => 'ocf_member_profile_friends',
     ...
     */
    public function tpl_preview__ocf_member_profile_friends()
    {
        require_lang('chat');
        require_lang('ocf');
        require_css('ocf');
