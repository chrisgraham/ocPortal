...
class Hook_addon_registry_core_ocf
{
    ...
    public function get_file_list()
    {
        return array(
            ...
            'sources/hooks/systems/notifications/ocf_rank_promoted.php',
            ...
            'sources/hooks/systems/occle_fs/groups.php',
            ...
            'themes/default/images/ocf_emoticons/boat.png',
            'themes/default/images/ocf_emoticons/fishing.png',
            'themes/default/images/ocf_emoticons/reallybadday.gif',
            'lang/EN/ocf.ini',
            ...
            'sources/hooks/systems/cleanup/ocf.php',
            'sources/hooks/systems/cleanup/ocf_members.php',
            ...
            'themes/default/templates/OCF_AUTO_TIME_ZONE_ENTRY.tpl',
            'themes/default/templates/OCF_DELURK_CONFIRM.tpl',
            'themes/default/templates/OCF_JOIN_STEP2_SCREEN.tpl',
            ...
            'themes/default/templates/OCF_MEMBER_BOX.tpl',
            'themes/default/templates/OCF_RANK_IMAGE.tpl',
    ...
    {
        return array(
            'templates/OCF_DELURK_CONFIRM.tpl' => 'administrative__ocf_delurk_confirm',
            'templates/OCF_JOIN_STEP1_SCREEN.tpl' => 'ocf_join_step1_screen',
            'templates/OCF_JOIN_STEP2_SCREEN.tpl' => 'ocf_join_step2_screen',
            'templates/OCF_AUTO_TIME_ZONE_ENTRY.tpl' => 'ocf_auto_time_zone_entry',
            'templates/OCF_USER_MEMBER.tpl' => 'ocf_user_member',
            'templates/OCF_MEMBER_ACTION.tpl' => 'ocf_member_profile_screen',
            'templates/OCF_EMOTICON_ROW.tpl' => 'ocf_emoticon_table',
            'templates/OCF_EMOTICON_CELL.tpl' => 'ocf_emoticon_table',
            'templates/OCF_EMOTICON_TABLE.tpl' => 'ocf_emoticon_table',
            'templates/OCF_MEMBER_DIRECTORY_SCREEN.tpl' => 'ocf_member_directory_screen',
            'templates/OCF_MEMBER_PROFILE_SCREEN.tpl' => 'ocf_member_profile_screen',
            'templates/OCF_MEMBER_PROFILE_ABOUT.tpl' => 'ocf_member_profile_screen',
            'templates/OCF_MEMBER_PROFILE_EDIT.tpl' => 'ocf_member_profile_screen',
            'templates/OCF_USERS_ONLINE_ROW.tpl' => 'ocf_users_online_screen',
            'templates/OCF_USERS_ONLINE_SCREEN.tpl' => 'ocf_users_online_screen',
            'templates/OCF_GROUP_DIRECTORY_SCREEN.tpl' => 'ocf_group_directory_screen',
            'templates/OCF_VIEW_GROUP_MEMBER.tpl' => 'ocf_view_group_screen',
            'templates/OCF_VIEW_GROUP_MEMBER_PROSPECTIVE.tpl' => 'ocf_view_group_screen',
            'templates/OCF_VIEW_GROUP_MEMBER_SECONDARY.tpl' => 'ocf_view_group_screen',
            'templates/OCF_VIEW_GROUP_SCREEN.tpl' => 'ocf_view_group_screen',
            'templates/BLOCK_MAIN_MEMBERS.tpl' => 'block_main_members',
            'templates/OCF_MEMBER_DIRECTORY_SCREEN_FILTER.tpl' => 'ocf_member_directory_screen_filter',
            'templates/OCF_MEMBER_DIRECTORY_USERNAME.tpl' => 'ocf_member_directory_username',
        );
    }
     ...
     */
    public function tpl_preview__administrative__ocf_delurk_confirm()
    {
        return array(
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_join_step2_screen()
    {
        require_css('forms');
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_auto_time_zone_entry()
    {
        return array(
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_user_member()
    {
        return array(
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_member_directory_screen_filter()
    {
        return array(
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_member_directory_username()
    {
        return array(
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_member_directory_screen()
    {
        return array(
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_member_profile_screen()
    {
        require_lang('news');
        $sections = array(
            'contact' => lorem_word(),
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_group_directory_screen()
    {
        return array(
