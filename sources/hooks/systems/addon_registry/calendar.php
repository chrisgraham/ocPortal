...
class Hook_addon_registry_calendar
{
	...
	function get_file_list()
	{
		return array(
			...
			'CALENDAR_SCREEN.tpl',
			'CALENDAR_SCREEN_PERSONAL_SUBSCRIPTION.tpl',
			'CALENDAR_SCREEN_SUBSCRIPTION.tpl',
			'CALENDAR_WEEK.tpl',
			...
			'themes/default/images/calendar/holiday.png',
	...
	*/
	function tpl_preview__calendar_year_view()
	{
		return array(
			lorem_globalise(
			$this->calendar_main_screen('year'),NULL,'',true),
		);
	}
	...
	*/
	function tpl_preview__calendar_month_view()
	{
		return array(
			lorem_globalise(
			$this->calendar_main_screen('month'),NULL,'',true),
		);
	}
	...
	*/
	function tpl_preview__calendar_week_view()
	{
		return array(
			lorem_globalise(
			$this->calendar_main_screen('week'),NULL,'',true),
		);
	}
	...
	*/
	function tpl_preview__calendar_day_view()
	{
		return array(
			lorem_globalise(
			$this->calendar_main_screen('day'),NULL,'',true),
		);
	}
	...
	*/
	function tpl_preview__block_side_calendar()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('BLOCK_SIDE_CALENDAR',array(
	...
	*/
	function tpl_preview__block_side_calendar_listing()
	{
		return array(
			lorem_globalise(
				do_lorem_template('BLOCK_SIDE_CALENDAR_LISTING',array(
	...
	*/
	function tpl_preview__calendar_event_conflict()
	{
		return array(
			lorem_globalise(
				do_lorem_template('CALENDAR_EVENT_CONFLICT',array(
					'URL'=>placeholder_url(),
					'ID'=>placeholder_id(),
					'TITLE'=>lorem_word(),
						)
	...
	*/
	function tpl_preview__calendar_screen()
	{
		...
		{
			$sub->attach(do_lorem_template('CALENDAR_SCREEN_PERSONAL_SUBSCRIPTION',array(
		...
		foreach(placeholder_array() as $v)
		{
			$subed->attach(do_lorem_template('CALENDAR_SCREEN_SUBSCRIPTION',array(
		...
		return array(
			lorem_globalise(
				do_lorem_template('CALENDAR_SCREEN',array(
					'ID'=>placeholder_id(),
