...
class Hook_addon_registry_catalogues
{
	...
	function get_file_list()
	{
		return array(
			...
			'sources/hooks/modules/catalogue_fields/.htaccess',
			'sources/hooks/modules/catalogue_fields/auto_increment.php',
			'sources/hooks/modules/catalogue_fields/page_link.php',
			'sources/hooks/modules/catalogue_fields/date.php',
			'sources/hooks/modules/catalogue_fields/email.php',
			'sources/hooks/modules/catalogue_fields/float.php',
			'sources/hooks/modules/catalogue_fields/index.html',
			'sources/hooks/modules/catalogue_fields/integer.php',
			'sources/hooks/modules/catalogue_fields/isbn.php',
			'sources/hooks/modules/catalogue_fields/list.php',
			'sources/hooks/modules/catalogue_fields/radiolist.php',
			'sources/hooks/modules/catalogue_fields/long_text.php',
			'sources/hooks/modules/catalogue_fields/long_trans.php',
			'sources/hooks/modules/catalogue_fields/picture.php',
			'sources/hooks/modules/catalogue_fields/random.php',
			'sources/hooks/modules/catalogue_fields/reference.php',
			'sources/hooks/modules/catalogue_fields/short_text.php',
			'sources/hooks/modules/catalogue_fields/short_trans.php',
			'sources/hooks/modules/catalogue_fields/tick.php',
			'sources/hooks/modules/catalogue_fields/upload.php',
			'sources/hooks/modules/catalogue_fields/url.php',
			'sources/hooks/modules/catalogue_fields/user.php',
