...
class Hook_addon_registry_galleries
{
    ...
    public function tpl_previews()
    {
        return array(
            ...
            'templates/OCF_MEMBER_PROFILE_GALLERIES.tpl' => 'ocf_member_profile_galleries',
            'templates/BLOCK_MAIN_PERSONAL_GALLERIES_LIST.tpl' => 'ocf_member_profile_galleries',
     ...
     * @return array                    Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
     */
    public function tpl_preview__ocf_member_profile_galleries()
    {
