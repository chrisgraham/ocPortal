...
class Hook_addon_registry_core_rich_media
{
	...
	function get_file_list()
	{
		return array(
			...
			'COMCODE_CEDI_LINK.tpl',
			'themes/default/images/cedi_link.png',
			'themes/default/images/cedi_link_hover.png',
	...
	*/
	function tpl_previews()
	{
		return array(
				...
				'COMCODE_EXP_THUMB_PRINT.tpl'=>'comcode_exp_thumb_print',
				...
				'COMCODE_CEDI_LINK.tpl'=>'comcode_cedi_link',
	...
	*/
	function tpl_preview__comcode_big_tabs()
	{
		...
		{
			$page[] = lorem_word().placeholder_random();
		}
	...
	*/
	function tpl_preview__comcode_edit_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_EDIT_SCREEN',array(
					'NEW'=>lorem_phrase(),
	...
	*/
	function tpl_preview__comcode_tooltip()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_TOOLTIP',array(
					'URL'=>placeholder_url(),
	...
	*/
	function tpl_preview__emoticon_click_code()
	{
		...
		$emt->attach(do_lorem_template('EMOTICON_IMG_CODE_DIR',array(
				'EMOTICON'=>lorem_word(),
		...
		return array(
			lorem_globalise(
				do_lorem_template('EMOTICON_CLICK_CODE',array(
	...
	*/
	function tpl_preview__comcode_critical_parse_error()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CRITICAL_PARSE_ERROR',array(
					'LINE'=>lorem_phrase(),
	...
	*/
	function tpl_preview__comcode_mistake_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_MISTAKE_SCREEN',array(
	...
	*/
	function tpl_preview__comcode_currency()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CURRENCY',array(
	...
	*/
	function tpl_preview__comcode_overlay()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_OVERLAY',array(
	...
	*/
	function tpl_preview__comcode_snapback()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_SNAPBACK',array(
					'URL'=>placeholder_url(),
					'TITLE'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_carousel()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CAROUSEL',array(
					'CONTENT'=>$content,
	...
	*/
	function tpl_preview__comcode_if_in_group()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_IF_IN_GROUP',array(
					'TYPE'=>'',
					'CONTENT'=>lorem_phrase(),
					'GROUPS'=>lorem_phrase(),
						)
	...
	*/
	function tpl_preview__comcode_abbr()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_ABBR',array(
					'CONTENT'=>lorem_phrase(),
					'TITLE'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_address()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_ADDRESS',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_dfn()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_DFN',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_q()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_Q',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_pulse()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_PULSE',array(
					'RAND_ID'=>placeholder_id(),
					'CONTENT'=>lorem_phrase(),
					'MIN_COLOR'=>'#000000',
					'MAX_COLOR'=>'#FFFFFF',
					'SPEED'=>'1000',
	...
	*/
	function tpl_preview__comcode_del()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_DEL',array(
					'CONTENT'=>lorem_phrase(),
					'CITE'=>lorem_word(),
	...
	*/
	function tpl_preview__comcode_ins()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_INS',array(
					'CONTENT'=>lorem_phrase(),
					'CITE'=>lorem_word(),
					'DATETIME'=>placeholder_time()
						)
	...
	*/
	function tpl_preview__comcode_cite()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CITE',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_bold()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_BOLD',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_align()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_ALIGN',array(
					'ALIGN'=>'left',
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_indent()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_INDENT',array(
	...
	*/
	function tpl_preview__comcode_surround()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_SURROUND',array(
					'CLASS'=>lorem_phrase(),
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_italics()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_ITALICS',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_underline()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_UNDERLINE',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_strike()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_STRIKE',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_sup()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_SUP',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_sub()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_SUB',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_random()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_RANDOM',array(
	...
	*/
	function tpl_preview__comcode_jumping()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_JUMPING',array(
					'UNIQID'=>placeholder_id(),
					'FULL'=>lorem_phrase(),
					'TIME'=>'1000',
					'PARTS'=>$part,
	...
	*/
	function tpl_preview__comcode_ticker()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_TICKER',array(
					'UNIQID'=>placeholder_id(),
					'SPEED'=>'10',
					'WIDTH'=>'400',
					'TEXT'=>lorem_sentence_html(),
	...
	*/
	function tpl_preview__comcode_highlight()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_HIGHLIGHT',array(
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_font()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_FONT',array(
					'CONTENT'=>lorem_phrase(),
					'SIZE'=>"font-size:2em;",
					'COLOR'=>'color:red;',
	...
	*/
	function tpl_preview__comcode_concept()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CONCEPT',array(
					'TEXT'=>lorem_sentence(),
					'URL'=>placeholder_url(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_concept_inline()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CONCEPT_INLINE',array(
					'TEXT'=>lorem_sentence(),
					'FULL'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_concepts()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CONCEPTS',array(
					'TITLE'=>lorem_phrase(),
					'CONCEPTS'=>$concept,
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_exp_ref()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_EXP_REF',array(
					'TEXT'=>lorem_sentence(),
					'URL'=>placeholder_url(),
						)
			),NULL,'',true),
	...
	* @return array			Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
	*/
	function tpl_preview__comcode_exp_thumb_print()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_EXP_THUMB_PRINT',array(
					'FLOAT'=>'left',
					'TEXT'=>lorem_phrase(),
					'URL_FULL'=>placeholder_image_url(),
						)
			),NULL,'',true),
		);
	}
	...
	*/
	function tpl_preview__comcode_exp_thumb()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_EXP_THUMB',array(
					'FLOAT'=>'left',
					'TEXT'=>lorem_sentence(),
	...
	*/
	function tpl_preview__comcode_thumb()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_THUMB',array(
	...
	*/
	function tpl_preview__comcode_img()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_IMG',array(
					'REFRESH_TIME'=>'20000',
	...
	*/
	function tpl_preview__comcode_swf()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_SWF',array(
					'URL'=>placeholder_url(),
					'WIDTH'=>placeholder_number(),
					'HEIGHT'=>placeholder_number(),
						)
	...
	*/
	function tpl_preview__comcode_url()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_URL',array(
					'TITLE'=>lorem_phrase(),
					'REL'=>lorem_phrase(),
					'TARGET'=>lorem_phrase(),
					'URL'=>placeholder_url(),
	...
	*/
	function tpl_preview__comcode_email()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_EMAIL',array(
					'TITLE'=>lorem_phrase(),
	...
	*/
	function tpl_preview__comcode_reference()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_REFERENCE',array(
					'SOURCE'=>lorem_phrase(),
						)
			),NULL,'',true),
		);
	...
	*/
	...
	{
		$attributes=array('left_1'=>'Ra Ra','right_1'=>'ah-ah-ah','left_2'=>'Roma','right_2'=>'Roma-ma','left_3'=>'GaGa','right_3'=>'Oh la-la','left_4'=>'Want your','right_4'=>'bad romance');
		...
		foreach ($attributes as $key=>$val)
		{
			if (substr($key,0,5)=='left_')
			{
				...
				$_parts->attach(do_lorem_template('COMCODE_SHOCKER_PART',array('LEFT'=>$left,'RIGHT'=>$right)));
			}
		}
		...
		$temp_tpl=do_lorem_template('COMCODE_SHOCKER',array('UNIQID'=>placeholder_random(),'MIN_COLOR'=>$min_color,'MAX_COLOR'=>$max_color,'FULL'=>implode(', ',$attributes),'TIME'=>strval(4000),'PARTS'=>$_parts));
	...
	*/
	function tpl_preview__comcode_hide()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_HIDE',array(
					'TEXT'=>lorem_sentence_html(),
					'CONTENT'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_quote_by()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_QUOTE_BY',array(
					'CONTENT'=>lorem_phrase(),
					'BY'=>lorem_phrase(),
					'CITE'=>lorem_word(),
	...
	*/
	function tpl_preview__comcode_quote()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_QUOTE',array(
					'CONTENT'=>lorem_phrase(),
					'CITE'=>lorem_word(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_contents()
	{
		...
		$line->attach(do_lorem_template('COMCODE_CONTENTS_LINE_FINAL',array(
					'URL'=>placeholder_url(),
					'LINE'=>lorem_phrase(),
					'ID'=>placeholder_id(),
						)
	...
	*/
	function tpl_preview__comcode_textcode_line()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_TEXTCODE_LINE',array(
						)
			),NULL,'',true),
		);
	}
	...
	*/
	function tpl_preview__comcode_textcode_tab()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_TEXTCODE_TAB',array(
						)
			),NULL,'',true),
		);
	}
	...
	* @return array			Array of previews, each is Tempcode. Normally we have just one preview, but occasionally it is good to test templates are flexible (e.g. if they use IF_EMPTY, we can test with and without blank data).
	*/
	function tpl_preview__comcode_cedi_link()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CEDI_LINK',array(
					'URL'=>placeholder_url(),
					'TEXT'=>lorem_sentence(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_table_screens()
	{
		...
		$tag_output->attach(do_lorem_template('COMCODE_CODE_SCROLL',array('TITLE'=>lorem_phrase(),'CONTENT'=>lorem_phrase(),'TYPE'=>'')));
		$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_START',array('WIDTH'=>'100%','FLOAT'=>'left','PADDING'=>'','PADDING_AMOUNT'=>'5')));
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_START',array('WIDTH'=>'40%','FLOAT'=>'left','PADDING'=>'-left','PADDING_AMOUNT'=>'10')));
		...
		$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_WIDE_START',array('WIDTH'=>'100%','FLOAT'=>'left','PADDING'=>'','PADDING_AMOUNT'=>'5')));
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_START',array('WIDTH'=>'40%','FLOAT'=>'left','PADDING'=>'-left','PADDING_AMOUNT'=>'10')));
				$tag_output->attach(lorem_word());
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_END'));
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_START',array('WIDTH'=>'40%','FLOAT'=>'left','PADDING'=>'-left','PADDING_AMOUNT'=>'10')));
		...
		$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_2_START',array('WIDTH'=>'100%','FLOAT'=>'left','PADDING'=>'','PADDING_AMOUNT'=>'5')));
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_START',array('WIDTH'=>'40%','FLOAT'=>'left','PADDING'=>'-left','PADDING_AMOUNT'=>'10')));
				$tag_output->attach(lorem_word());
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_END'));
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_START',array('WIDTH'=>'40%','FLOAT'=>'left','PADDING'=>'-left','PADDING_AMOUNT'=>'10')));
		...
		$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_WIDE2_START',array('WIDTH'=>'100%','PADDING_AMOUNT'=>'0','FLOAT'=>'left','PADDING'=>'')));
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_WIDE2_START',array('WIDTH'=>'40%','FLOAT'=>'left','PADDING'=>'-left','PADDING_AMOUNT'=>'10')));
				$tag_output->attach(lorem_word());
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_END'));
			$tag_output->attach(do_lorem_template('COMCODE_FAKE_TABLE_WIDE2_START',array('WIDTH'=>'40%','FLOAT'=>'left','PADDING'=>'-left','PADDING_AMOUNT'=>'10')));
				$tag_output->attach(lorem_word());
		...
		$tag_output->attach(do_lorem_template('COMCODE_REAL_TABLE_START',array('SUMMARY'=>lorem_phrase(),'CAPTION'=>lorem_word())));
		...
		foreach (placeholder_array(2) as $table_row)
		{
			...
			{
				$tag_output->attach(do_lorem_template('COMCODE_REAL_TABLE_CELL',array('WIDTH'=>'','C_TYPE'=>'td','MID'=>$cell)));
			}
		...
		$tag_output->attach(do_lorem_template('COMCODE_REAL_TABLE_START_SUMMARY',array('CAPTION'=>lorem_word())));
	...
	*/
	function tpl_preview__comcode_minor_title()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_MINOR_TITLE',array(
					'ID'=>placeholder_id(),
					'TITLE'=>lorem_phrase(),
					'SUB'=>lorem_sentence(),
						)
	...
	*/
	function tpl_preview__attachments_browser()
	{
		...
		foreach(placeholder_array() as $k=>$v)
		{
			$list_cont->attach(do_lorem_template('FORM_SCREEN_INPUT_LIST_ENTRY',array('SELECTED'=>'','DISABLED'=>'','CLASS'=>'','NAME'=>$v,'TEXT'=>$v)));
		}
		...
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENTS_BROWSER',array(
					'LIST'=>$list_cont,
					'CONTENT'=>$content,
					'URL'=>placeholder_url(),
						)
	...
	*/
	function tpl_preview__attachment_left()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_LEFT',array(
					'CONTENT'=>$temp_tpl,
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__attachment_right()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_RIGHT',array(
					'CONTENT'=>$temp_tpl,
						)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__attachment_swf()
	{
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_SWF',array(
					'SCRIPT'=>placeholder_url(),
					'ID'=>placeholder_id(),
	...
	*/
	function tpl_preview__attachment_qt()
	{
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_QT',array(
					'SCRIPT'=>placeholder_url(),
					'ID'=>placeholder_id(),
					'A_WIDTH'=>placeholder_number(),
					'A_HEIGHT'=>placeholder_number(),
	...
	*/
	function tpl_preview__attachment_rm()
	{
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_RM',array(
					'SCRIPT'=>placeholder_url(),
					'ID'=>placeholder_id(),
					'A_WIDTH'=>placeholder_number(),
					'A_HEIGHT'=>placeholder_number(),
	...
	*/
	function tpl_preview__attachment_media()
	{
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_MEDIA',array(
							'SCRIPT'=>placeholder_url(),
							'ID'=>placeholder_id(),
							'A_WIDTH'=>placeholder_number(),
							'A_HEIGHT'=>placeholder_number(),
	...
	*/
	function tpl_preview__comcode_code()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_CODE',array(
					'STYLE'=>lorem_phrase(),
					'TYPE'=>lorem_phrase(),
					'CONTENT'=>lorem_phrase(),
					'TITLE'=>lorem_phrase(),
	...
	*/
	function tpl_preview__attachment_download_remote()
	{
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_DOWNLOAD_REMOTE',array(
	...
	*/
	function tpl_preview__attachment_download()
	{
		return array(
			lorem_globalise(
				do_lorem_template('ATTACHMENT_DOWNLOAD',array(
					'SCRIPT'=>placeholder_url(),
					'A_DESCRIPTION'=>lorem_word(),
					'A_ORIGINAL_FILENAME'=>lorem_word_2(),
					'ID'=>placeholder_id(),
	...
	*/
	function tpl_preview__standardbox_accordion()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('STANDARDBOX_accordion',array(
	...
	*/
	function tpl_preview__comcode_tab_body()
	{
		...
		return array(
			lorem_globalise(
						do_lorem_template('COMCODE_TAB_CONTROLLER',array(
							'HEADS'=>$head,
							'CONTENT'=>$content,
							)
			),NULL,'',true),
	...
	*/
	function tpl_preview__comcode_samp()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_SAMP',array(
					'CONTENT'=>lorem_sentence()
					)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_section_title()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_SECTION_TITLE',array(
					'ID'=>placeholder_id(),
					'TITLE'=>lorem_phrase(),
					'SUB'=>lorem_sentence(),
					)
	...
	*/
	function tpl_preview__comcode_var()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_VAR',array(
					'CONTENT'=>lorem_sentence()
					)
			),NULL,'',true),
		);
	...
	*/
	function tpl_preview__comcode_very_minor_title()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_VERY_MINOR_TITLE',array(
					'ID'=>placeholder_id(),
					'TITLE'=>lorem_phrase(),
					'SUB'=>lorem_sentence(),
					)
	...
	*/
	function tpl_preview__comcode_teletype()
	{
		return array(
			lorem_globalise(
				do_lorem_template('COMCODE_TELETYPE',array(
					'CONTENT'=>lorem_sentence()
					)
			),NULL,'',true),
		);
