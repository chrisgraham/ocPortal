...
class Hook_addon_registry_core_abstract_interfaces
{
	...
	function get_file_list()
	{
		return array(
			...
			'VIEW_SPACE.tpl',
			'VIEW_SPACE_FIELD.tpl',
			'VIEW_SPACE_FIELD_ABBR.tpl',
			'VIEW_SPACE_FIELD_RAW.tpl',
			'VIEW_SPACE_FIELD_RAW_ABBR.tpl',
			'VIEW_SPACE_SCREEN.tpl',
			'TABLE_TABLE.tpl',
			'TABLE_TABLE_SCREEN.tpl',
			'TABLE_TABLE_ROW_CELL_SELECT.tpl',
			'TABLE_TABLE_ACTION_DELETE_CATEGORY.tpl',
			'TABLE_TABLE_ACTION_DELETE_ENTRY.tpl',
			'TABLE_TABLE_ACTION_INSTALL_ENTRY.tpl',
			'TABLE_TABLE_ACTION_REINSTALL_ENTRY.tpl',
			'TABLE_TABLE_ACTION_TRANSLATE.tpl',
			'TABLE_TABLE_ACTION_UPGRADE_ENTRY.tpl',
			'TABLE_TABLE_ACTION_DOWNLOAD.tpl',
			'TABLE_TABLE_HEADER_ROW.tpl',
			'TABLE_TABLE_HEADER_ROW_CELL.tpl',
			'TABLE_TABLE_ROW.tpl',
			'TABLE_TABLE_ROW_CELL.tpl',
			'RESULTS_BROWSER_CONTINUE.tpl',
			'RESULTS_BROWSER_CONTINUE_LAST.tpl',
			'RESULTS_BROWSER_CONTINUE_FIRST.tpl',
			'RESULTS_BROWSER_LIST_PAGES.tpl',
			'RESULTS_BROWSER_NEXT.tpl',
			'RESULTS_BROWSER_NEXT_LINK.tpl',
			'RESULTS_BROWSER_PAGE_NUMBER.tpl',
			'RESULTS_BROWSER_PAGE_NUMBER_LINK.tpl',
			'RESULTS_BROWSER_PER_SCREEN.tpl',
			'RESULTS_BROWSER_PER_PAGE_OPTION.tpl',
			'RESULTS_BROWSER_PREVIOUS.tpl',
			'RESULTS_BROWSER_PREVIOUS_LINK.tpl',
			'RESULTS_BROWSER_SORT.tpl',
			'RESULTS_BROWSER_SORTER.tpl',
			'RESULTS_BROWSER_WRAP.tpl',
			...
			'JAVASCRIPT_RESULTS_BROWSER.tpl',
			'IFRAME_SCREEN.tpl',
			...
			'sources/templates_results_browser.php',
			'sources/templates_table_table.php',
			'sources/templates_view_space.php',
	...
	*/
	function tpl_previews()
	{
		return array(
				...
				'YESNO_SCREEN.tpl'=>'yesno_screen',
				'REDIRECT_SCREEN.tpl'=>'redirect_screen',
				'CONFIRM_SCREEN.tpl'=>'confirm_screen',
				'RESULTS_TABLE_SCREEN.tpl'=>'result_table_screen',
				'TABLE_TABLE_ACTION_DELETE_ENTRY.tpl'=>'full_table_screen',
				'TABLE_TABLE.tpl'=>'full_table_screen',
				...
				'TABLE_TABLE_ACTION_INSTALL_ENTRY.tpl'=>'full_table_screen',
				'TABLE_TABLE_ACTION_UPGRADE_ENTRY.tpl'=>'full_table_screen',
				'TABLE_TABLE_ACTION_REINSTALL_ENTRY.tpl'=>'full_table_screen',
				'VIEW_SPACE.tpl'=>'view_space',
				'VIEW_SPACE_SCREEN.tpl'=>'view_space_screen',
				'TABLE_TABLE_ACTION_DELETE_CATEGORY.tpl'=>'table_table_action_delete_category',
				'POPUP_HTML_WRAP.tpl'=>'popup_html_wrap',
				'SPLURGH.tpl'=>'splurgh_screen',
				'NEXT_BROWSER_BROWSE_NEXT.tpl'=>'next_browser_screen',
				'WARNING_TABLE.tpl'=>'warning_table',
				'RESULTS_BROWSER_SORTER.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_SORT.tpl'=>'result_table_screen',
				...
				'TABLE_TABLE_HEADER_ROW_CELL.tpl'=>'full_table_screen',
				'TABLE_TABLE_HEADER_ROW.tpl'=>'full_table_screen',
				'TABLE_TABLE_ROW_CELL.tpl'=>'full_table_screen',
				'TABLE_TABLE_ROW.tpl'=>'full_table_screen',
				...
				'RESULTS_BROWSER_PER_PAGE_OPTION.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_PER_SCREEN.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_CONTINUE_FIRST.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_PREVIOUS_LINK.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_PREVIOUS.tpl'=>'result_table_screen_2',
				'RESULTS_BROWSER_CONTINUE.tpl'=>'result_table_screen_2',
				'RESULTS_BROWSER_PAGE_NUMBER.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_PAGE_NUMBER_LINK.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_NEXT_LINK.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_NEXT.tpl'=>'result_table_screen_2',
				'RESULTS_BROWSER_CONTINUE_LAST.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_LIST_PAGES.tpl'=>'result_table_screen',
				'RESULTS_BROWSER_WRAP.tpl'=>'result_table_screen',
				'FORM_CONFIRM_SCREEN.tpl'=>'form_confirm_screen',
				'VIEW_SPACE_FIELD.tpl'=>'view_space',
				'VIEW_SPACE_FIELD_ABBR.tpl'=>'view_space',
				'VIEW_SPACE_FIELD_RAW.tpl'=>'view_space',
				'VIEW_SPACE_FIELD_RAW_ABBR.tpl'=>'view_space',
				...
				'TABLE_TABLE_ACTION_DOWNLOAD.tpl'=>'table_table_action_download',
				'TABLE_TABLE_ACTION_TRANSLATE.tpl'=>'administrative__table_table_action_translate',
				'TABLE_TABLE_ROW_CELL_SELECT.tpl'=>'full_table_screen',
				'TABLE_TABLE_SCREEN.tpl'=>'administrative__table_table_screen',
			);
	}
	...
	*/
	function tpl_preview__index_screen_fancy_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('INDEX_SCREEN_FANCY_SCREEN',array(
					'TITLE'=>lorem_title(),
					'PRE'=>lorem_phrase(),
					'CONTENT'=>$content,
					'POST'=>lorem_phrase(),
	...
	*/
	function tpl_preview__administrative__table_table_action_translate()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('TABLE_TABLE_ACTION_TRANSLATE',array(
					'URL'=>placeholder_url(),
					'NAME'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__table_table_action_download()
	{
		return array(
			lorem_globalise(
				do_lorem_template('TABLE_TABLE_ACTION_DOWNLOAD',array(
					'URL'=>placeholder_url(),
					'NAME'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__yesno_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('YESNO_SCREEN',array(
					'TITLE'=>lorem_title(),
	...
	*/
	function tpl_preview__redirect_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('REDIRECT_SCREEN',array(
					'URL'=>placeholder_url(),
					'TITLE'=>lorem_title(),
					'TEXT'=>lorem_sentence_html(),
						)
	...
	*/
	function tpl_preview__confirm_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('CONFIRM_SCREEN',array(
					'TITLE'=>lorem_title(),
					'FIELDS'=>'',
					'URL'=>placeholder_url(),
	...
	*/
	function tpl_preview__index_screen_fancier_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('INDEX_SCREEN_FANCIER_SCREEN',array(
					'CONTENT'=>$entries,
					'TITLE'=>lorem_title(),
					'POST'=>lorem_phrase(),
					'PRE'=>lorem_phrase(),
	...
	*/
	function tpl_preview__view_space()
	{
		...
		$fields->attach(do_lorem_template('VIEW_SPACE_FIELD',array('NAME'=>lorem_word(),'VALUE'=>lorem_phrase())));
		$fields->attach(do_lorem_template('VIEW_SPACE_FIELD_ABBR',array('ABBR'=>lorem_phrase(),'NAME'=>lorem_word(),'VALUE'=>lorem_phrase())));
		$fields->attach(do_lorem_template('VIEW_SPACE_FIELD_RAW_ABBR',array('ABBR'=>lorem_phrase(),'NAME'=>lorem_word(),'VALUE'=>lorem_phrase())));
		$fields->attach(do_lorem_template('VIEW_SPACE_FIELD_RAW',array('NAME'=>lorem_word(),'VALUE'=>lorem_phrase())));

		return array(
			lorem_globalise(
				do_lorem_template('VIEW_SPACE',array(
	...
	*/
	function tpl_preview__view_space_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('VIEW_SPACE_SCREEN',array(
					'TITLE'=>lorem_title(),
					'FIELDS'=>$fields
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__table_table_action_delete_category()
	{
		return array(
			lorem_globalise(
				do_lorem_template('TABLE_TABLE_ACTION_DELETE_CATEGORY',array(
					'URL'=>placeholder_url(),
					'NAME'=>lorem_phrase(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__popup_html_wrap()
	{
		return array(
			lorem_globalise(
				do_lorem_template('POPUP_HTML_WRAP',array(
					'TITLE'=>lorem_phrase(),
	...
	*/
	function tpl_preview__warning_table()
	{
		return array(
			lorem_globalise(
				do_lorem_template('WARNING_TABLE',array(
	...
	*/
	function tpl_preview__simple_preview_box()
	{
		return array(
			lorem_globalise(
				do_lorem_template('SIMPLE_PREVIEW_BOX',array(
	...
	*/
	function tpl_preview__inform_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('INFORM_SCREEN',array(
					'TITLE'=>lorem_title(),
					'TEXT'=>lorem_sentence(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__iframe_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('IFRAME_SCREEN',array(
					'TITLE'=>lorem_title(),
	...
	*/
	function tpl_preview__warn_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('WARN_SCREEN',array(
					'TITLE'=>lorem_title(),
	...
	*/
	function tpl_preview__administrative__do_next_screen()
	{
		...
		$list=array(
						...
						array('cms_home',array(NULL,array(),'')),
						array('admin_home',array(NULL,array(),'')),
                  );
		...
		return array(
			lorem_globalise(
				do_lorem_template('DO_NEXT_SCREEN',array(
	...
	*/
	function tpl_preview__question_ui_buttons()
	{
		return array(
			lorem_globalise(
				do_lorem_template('QUESTION_UI_BUTTONS',array(
	...
	*/
	function tpl_preview__next_browser_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('NEXT_BROWSER_SCREEN',array(
					'TITLE'=>lorem_title(),
					'CONTENT'=>lorem_phrase(),
					'BROWSE'=>$browse,
						)
	...
	*/
	function tpl_preview__splurgh_screen()
	{
		...
		return array(
			lorem_globalise(
				do_lorem_template('SPLURGH_SCREEN',array(
					'TITLE'=>lorem_title(),
					'CONTENT'=>$content
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__full_message_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('FULL_MESSAGE_SCREEN',array(
					'TITLE'=>lorem_title(),
					'TEXT'=>lorem_sentence(),
						)
			),NULL,'',true),
	...
	*/
	function tpl_preview__result_launcher_screen()
	{
		...
		foreach (placeholder_array() as $k=>$v)
		{
			$part->attach(do_lorem_template('RESULTS_LAUNCHER_PAGE_NUMBER_LINK',array('TITLE'=>lorem_phrase(),'URL'=>placeholder_url(),'P'=>placeholder_number())));
			$part->attach(do_lorem_template('RESULTS_LAUNCHER_CONTINUE',array('TITLE'=>lorem_phrase(),'MAX'=>placeholder_number(),'NUM_PAGES'=>placeholder_number(),'URL_STUB'=>placeholder_url())));
		}

		$pages = do_lorem_template('RESULTS_LAUNCHER_WRAP',array('PART'=>$part));
	...
	*/
	function tpl_preview__administrative__table_table_screen()
	{
		return array(
			lorem_globalise(
				do_lorem_template('TABLE_TABLE_SCREEN',array(
					'TITLE'=>lorem_title(),
