...
class Hook_page_stats
{
	...
	function run()
	{
		...
		if (is_null($delete_older_than))
		{
			...
			$tpl=do_template('FORM_SCREEN',array('_GUID'=>'9fdb5fcf1cd0f5651d00b9e08d19d62a','SKIP_VALIDATION'=>true,'HIDDEN'=>$hidden,'TITLE'=>$title,'TEXT'=>do_lang_tempcode('DELETE_DATA_AVAILABLE'),'URL'=>$post_url,'FIELDS'=>$fields,'SUBMIT_ICON'=>'buttons__proceed','SUBMIT_NAME'=>$submit_name));
