...
class Hook_rss_ocf_members
{
	...
	function run($_filters,$cutoff,$prefix,$date_string,$max)
	{
		...
		$rows=$GLOBALS['FORUM_DB']->query('SELECT * FROM '.$GLOBALS['SITE_DB']->get_table_prefix().'f_members p WHERE m_join_time>'.strval($cutoff).(((!has_privilege(get_member(),'see_unvalidated')) && (addon_installed('unvalidated')))?' AND m_validated=1 AND m_validated_email_confirm_code=\'\' ':'').' ORDER BY m_join_time DESC',$max);
