...
class Hook_rss_ocf_forumview
{
	...
	function run($_filters,$cutoff,$prefix,$date_string,$max)
	{
		...
		$rows=$GLOBALS['FORUM_DB']->query('SELECT * FROM '.$GLOBALS['FORUM_DB']->get_table_prefix().'f_topics WHERE t_cache_last_time>'.strval($cutoff).((!has_privilege(get_member(),'see_unvalidated'))?' AND t_validated=1 ':'').' AND '.$filters.' ORDER BY t_cache_last_time DESC',$max);
