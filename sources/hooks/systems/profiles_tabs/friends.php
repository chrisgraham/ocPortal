	...
	function render_tab($member_id_of,$member_id_viewing,$leave_to_ajax_if_possible=false)
	{
		...
		if (addon_installed('chat'))
		{
			...
			if (($member_id_of!=$member_id_viewing) && (!is_guest()))
			{
				...
				{
					$add_friend_url=build_url(array('page'=>'chat','type'=>'buddy_add','member_id'=>$member_id_of,'redirect'=>static_evaluate_tempcode($GLOBALS['FORUM_DRIVER']->member_profile_url($member_id_of,true,true))),get_module_zone('chat'));
				} else
				{
					$remove_friend_url=build_url(array('page'=>'chat','type'=>'buddy_remove','member_id'=>$member_id_of,'redirect'=>static_evaluate_tempcode($GLOBALS['FORUM_DRIVER']->member_profile_url($member_id_of,true,true))),get_module_zone('chat'));
				}
			}
