...
class Hook_media_rendering_svg
{
	/**
	...
	{
		if ($mime_type=='image/svg+xml') return MEDIA_RECOG_PRECEDENCE_HIGH;
	...
	{
		return do_template('MEDIA_SVG',array('HOOK'=>'svg')+_create_media_template_parameters($url,$attributes));
	}
