...
class Hook_media_rendering_realaudio
{
	...
	{
		if ($mime_type=='audio/x-pn-realaudio-plugin') return MEDIA_RECOG_PRECEDENCE_HIGH;
	...
	{
		return do_template('MEDIA_REALMEDIA',array('HOOK'=>'realaudio')+_create_media_template_parameters($url,$attributes,$as_admin,$source_member));
	}
