...
class Hook_occle_command_cp
{
	...
	{
		if ((array_key_exists('h',$options)) || (array_key_exists('help',$options))) return array('',do_command_help('cp',array('h'),array(true,true)),'','');
		else
		{
			if (!array_key_exists(0,$parameters)) return array('','','',do_lang('MISSING_PARAM','1','cp'));
			...
			$success=$occle_fs->copy_file($parameters[0],$parameters[1]);
