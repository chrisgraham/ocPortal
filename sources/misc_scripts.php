...
function gd_text_script()
{
	...
	if ((!function_exists('imagettftext')) || (strlen($text)==0))
	{
		$pfont=4;
...
function iframe_script()
{
	...
	if (($zones[0]['zone_name']!='') && (get_option('windows_auth_is_enabled',true)!='1') && ((get_session_id()==-1) || (is_guest()) || ($GLOBALS['SESSION_CONFIRMED']==0)) && (!is_guest()) && ($zones[0]['zone_require_session']==1))
