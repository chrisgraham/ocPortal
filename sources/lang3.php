...
function _choose_language($title, $tip = false, $allow_all_selection = false)
{
    ...
    $lang = either_param('lang', /*get_param('keep_lang',NULL)*/
        null);
    if ($lang !== null) {
    ...
    return do_template('FORM_SCREEN', array('_GUID' => '1a2823d450237aa299c095bf9c689a2a', 'SKIP_VALIDATION' => true, 'HIDDEN' => $hidden, 'SUBMIT_ICON' => 'buttons__proceed', 'SUBMIT_NAME' => do_lang_tempcode('PROCEED'), 'TITLE' => $title, 'FIELDS' => $fields, 'URL' => $url, 'TEXT' => $text));
}
 ...
 *
 * @param  LANGUAGE_NAME                $lang The language to have selected by default
