...
{
	if ((get_forum_type()=='ocf') && ($GLOBALS['FORUM_DRIVER']->get_member_row_field($member,'m_password_compat_scheme')=='temporary') && (get_page_name()!='members') || (get_param('type','misc')!='view'))
	{
