...
function init__users()
{
	...
	if (get_option('session_prudence',true)!=='1')
	{
...
function delete_expired_sessions_or_recover($member=NULL)
{
	...
	if ((get_value('disable_user_online_counting')!=='1') || (get_option('session_prudence',true)!=='1') || (mt_rand(0,1000)==123))
	{
...
function get_online_members($longer_time,$filter,&$count)
{
	...
	if (get_option('session_prudence',true)!=='0')
	{
