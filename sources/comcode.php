...
function init__comcode()
{
	...
	global $LAX_COMCODE;
	$LAX_COMCODE=(!function_exists('get_option') || get_option('complex_uploader')=='0'); // TODO: This should be a new accessibility option. It is bad to expect blind users to get Comcode precisely right, it's a lot harder when you can't scan visually.
}
