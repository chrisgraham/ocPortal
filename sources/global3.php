...
{
    if (ocp_srv('HTTP_UA_OS') != '') {
        return ocp_srv('HTTP_UA_OS');
...
function titleify($boring)
{
    ...
    if (substr($ret, 0, 3) == 'Oc ') {
        $ret = 'oc' . str_replace(' ', '', substr($ret, 3));
    }
