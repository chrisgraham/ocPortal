...
function _dispatch_notification_to_member($to_member_id,$setting,$notification_code,$code_category,$subject,$message,$from_member_id,$priority,$no_cc,$attachments)
{
	...
	if (_notification_setting_available(A_INSTANT_PT,$to_member_id))
	{
		if (($setting & A_INSTANT_PT) !=0)
		{
			...
			$topic_id=ocf_make_topic(NULL,$wrapped_subject,'1x/ocf_topic_modifiers/announcement',1,1,0,0,0,db_get_first_id(),$to_member_id,false,0,NULL,'');
