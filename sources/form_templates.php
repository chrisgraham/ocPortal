 ...
 *
 * @param  ID_TEXT                      $param The parameter stub (stub of a series of POST parameters, made by ocf_get_forum_multi_code_field's field or similar).
 ...
 * @param  boolean                      $content_centric Whether to get node titles in a website-friendly form, as opposed to a more technical explanation of what the nodes are
 * @return tempcode                     The input field
 */
 ...
 * @param  ?object                      $db The database connection to the OCF install we are choosing images from (null: site db)
