...
class Block_side_main_ocf_involved_topics
{
	...
	function run($map)
	{
		...
		inform_non_canonical_parameter('post_start');
		inform_non_canonical_parameter('post_max');
		...
		if (count($rows)!=0)
		{
			...
			if (!$topics->is_empty())
			{
				...
				$pagination=pagination(do_lang_tempcode('FORUM_TOPICS'),NULL,$start,$block_id.'_start',$max,$block_id.'_max',$max_rows,false,7,NULL);
