...
class Block_main_multi_content
{
	...
	function build_filter($filter,$info,$category_field_filter)
	{
		...
		return ocfilter_to_sqlfragment($filter,$info['id_field'],$parent_spec__table_name,$parent_spec__parent_name,$parent_field_name,$parent_spec__field_name,!$id_is_string,!$category_is_string);
	}
}
