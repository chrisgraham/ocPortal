	...
	function install($upgrade_from=NULL,$upgrade_from_hack=NULL)
	{
		if ((is_null($upgrade_from)) || ($upgrade_from < 3))
		{
			...
			$default_links=array(
				...
				'Internet Explorer Collection (for testing)'=>'http://finalbuilds.edskes.net/iecollection.htm',
				...
				'pngThing (compress PNG files, Mac)'=>'http://www.leveltendesign.com/blog/nickc/pngthing-v11-previously-pngoptimizer',
