...
//	} else $extra_files=array();
	...
	return array_merge($extra_files,array(
						...
						'pages/minimodules_custom','site/pages/minimodules_custom','docs/pages/minimodules_custom','adminzone/pages/minimodules_custom','forum/pages/minimodules_custom','personalzone/pages/minimodules_custom','cms/pages/minimodules_custom',
						'pages/modules_custom','site/pages/modules_custom','docs/pages/modules_custom','adminzone/pages/modules_custom','forum/pages/modules_custom','personalzone/pages/modules_custom','cms/pages/modules_custom',
						'pages/html_custom','site/pages/html_custom','docs/pages/html_custom','adminzone/pages/html_custom','forum/pages/html_custom','personalzone/pages/html_custom','cms/pages/html_custom',
						'pages/html_custom/'.$LANG,'site/pages/html_custom/'.$LANG,'docs/pages/html_custom/'.$LANG,'adminzone/pages/html_custom/'.$LANG,'forum/pages/html_custom/'.$LANG,'personalzone/pages/html_custom/'.$LANG,'cms/pages/html_custom/'.$LANG,
						'pages/comcode_custom','site/pages/comcode_custom','docs/pages/comcode_custom','adminzone/pages/comcode_custom','forum/pages/comcode_custom','personalzone/pages/comcode_custom','cms/pages/comcode_custom',
						'pages/comcode_custom/'.$LANG,'site/pages/comcode_custom/'.$LANG,'docs/pages/comcode_custom/'.$LANG,'adminzone/pages/comcode_custom/'.$LANG,'forum/pages/comcode_custom/'.$LANG,'personalzone/pages/comcode_custom/'.$LANG,'cms/pages/comcode_custom/'.$LANG,
