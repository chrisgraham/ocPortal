...
class Module_vforums
{
	...
	function _vforum($title,$condition,$order,$no_pin=false,$extra_tpl_map=NULL,$initial_table=NULL)
	{
		...
		$_buttons->attach(do_template('SCREEN_BUTTON',array('_GUID'=>'8c928f1f703e9ba232a7033adee19a31','TITLE'=>do_lang_tempcode('ROOT_FORUM'),'IMG'=>'buttons__all','IMMEDIATE'=>false,'URL'=>$archive_url)));
		if ($title->evaluate()==do_lang('TOPICS_UNREAD'))
		{
			$mark_read_url=build_url(array('page'=>'topics','type'=>'mark_read','id'=>db_get_first_id()),get_module_zone('topics'));
			$_buttons->attach(do_template('SCREEN_BUTTON',array('_GUID'=>'b96e17e77be6de6faf9eb340d7ba955a','TITLE'=>do_lang_tempcode('ROOT_FORUM'),'IMG'=>'buttons__mark_read_forum','IMMEDIATE'=>false,'URL'=>$mark_read_url)));
		}
